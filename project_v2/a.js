;
define("translation:widget/translate/appGuide/appGuide",
function(i, e, a) {
    "use strict";
    ...
    d = {
        ...
        init: function() {
            if (!/baiduinput/gi.test(window.navigator.userAgent)) {
                var i = n.getCookie(p);
                if (i) return void n.setCookie(p, "1", {
                    expires: 5184e6
                });
        ...
        clearSwipeTimer: function() {
            this.swiperTimer && (clearInterval(this.swiperTimer), this.swiperTimer = null)
        },
        bindEvent: function() {
            var i = this;
            $(".app-guide-close").on("click",
            function() {
                i.clearSwipeTimer(),
                t.addClass("app-guide-hide")
            });
            var e = this;
            $(".app-guide-main-left-pagination-index").on("click",
            function() {
                e.clearSwipeTimer();
                var i = $(this).index();
                e.curIdx = i;
...
define("translation:widget/translate/common/Drag",
function(t, s, o) {
    "use strict";
    var e = function(t, s) {
        this.isDrag = !1,
...
define("translation:widget/translate/common/hash",
function(t, e, n) {
    "use strict";
    function o(t) {
        return void 0 !== s[t]
    ...
    c.set = function(t, e, n) {
        ...
        h = o(e),
        f = r(n);
        if (i(n), s && h && f) l = [t + "/", e + "/", n];
        else if (s && h) l = [t + "/", e + "/"];
        else {
            if (!s) return void c.empty();
            l = [t + "/"]
        }
    ...
    c.get = function() {
        var t, e, n = location.hash;
        try {
            n = decodeURIComponent(n)
        } catch(o) {}
        if (n = n.replace(/^\#/, ""), n.indexOf("/") > 0) t = n.split("/"),
        e = t.length > 3 ? {
            from: t[0],
            to: t[1],
        ...
        } else 1 === t.length ? (t = t[0].split("2"), e = 2 === t.length ? {
            from: t[0],
            to: t[1],
            query: ""
        }: {
...
define("translation:widget/translate/common/sectrans",
function() {
    "use strict";
    function n() {
        $(document).on("click", ".sec-trans",
        function() {
...
define("translation:widget/translate/details/adLink/adLink",
function(n, i, t) {
    "use strict";
    function a() {
        window.adLinkInfo.isShowAdLink && (_hmt.push(["_trackEvent", "首页", "web端中部文字链广告展现"]), o())
    }
    function o() {
        $(".trans-other-wrap").on("click", ".hot-link-middle a",
        function() {
...
define("translation:widget/translate/sideNav/navSorter/listOperator",
function(t, i, n) {
    "use strict";
    function r(t, i) {
        var n = {},
    ...
    c = {
        ...
        initNavList: function() {
            ...
            if (t.length > 0 && n.is_login) {
                var e = r(t, i);
                return e.hasDiff && (t = e.targetList, this.setOwnerList(t)),
                this.setLocalList(t),
                a = t,
                t
            }
            ...
            if (o.length > 0) {
                var u = r(o, i);
                u.hasDiff && (o = u.targetList, this.setLocalList(o))
            } else o = i,
            this.setLocalList(o);
        ...
        setLocalList: function(t) {
            return new Promise(function(i) {
                if (a = t, !e.supportLocalStorage) return void i();
...
define("translation:widget/translate/sideNav/navSorter/ListDrag",
function(t, e, r) {
    "use strict";
    function a(t, e) {
    ...
    i = function() {
        ...
        },
        {
            ...
            value: function() {
                var t = this;
                this.$container.on("mousedown.listDrag", "." + this.itemClassName,
                function(e) {
                    if (0 === e.button) {
                        t.isDragging = !0,
                        ...
                        if (t.$dragTarget.addClass(t.itemClassName + "-dragging").css({
                            left: a,
                            top: n
                        }).before(t.$holdDom).attr("data-sortable", "n"), t.$sortableItems = t.$container.find('[data-sortable="y"]'), $.each(t.$sortableItems,
                        function(e, r) {
                            return $(r).hasClass("nav-st-item-hold") ? (t.holdIdx = e, !1) : void 0
                        }), t.hasOutWrapper) {
                ...
                $(document).on("mouseup.listDrag",
                function(e) {
                    if (0 !== e.button) return void e.preventDefault();
                    if (t.isDragging) {
                        t.isDragging = !1,
                ...
                $(window).on("scroll.listDrag",
                function() {
                    t.isDragging && (t.scrollTimer && clearTimeout(t.scrollTimer), t.scrollTimer = setTimeout(function() {
                        if (t.containerOffset = t.$container.offset(), t.hasOutWrapper) {
...
define("translation:widget/translate/toast/toast",
function(t, a, s) {
    "use strict";
    var e = $("#overall-toast"),
    o = void 0,
...
define("translation:widget/translate/sideNav/navSorter/navSorter",
function(t, n, i) {
    "use strict";
...
define("translation:widget/translate/sideNav/sideNav",
function(t, e, a) {
    "use strict";
    ...
    T = {
        ...
        bindClick: function() {
            r.on("click.sideNav", ".nav-item, .nav-sub-item",
            function(t) {
                var e = $(t.currentTarget),
                a = parseInt(e.attr("data-section-idx"), 10);
                T.scrollToSection(a)
            }),
            r.on("click", ".nav-search-again",
            function() {
                var t = void 0,
                e = void 0;
                $("html:not(:animated), body:not(:animated)").animate({
                ...
                if ("undefined" != typeof a.createTextRange) {
                    ...
                    n.select()
                } else "undefined" != typeof a.setSelectionRange && (t = 0, e = a.value.length, a.setSelectionRange(t, e));
                setTimeout(function() {
                    a.focus()
                },
                500),
        ...
        bindResize: function() {
            ...
            function() {
                u = $(window).height(),
                p && (T.setupPos(), T.checkPos())
            })
        },
        bindScroll: function() {
            $(window).on("scroll.sideNav",
            function() {
                if (p) {
                    T.setNavPos(),
                    T.checkPos(),
        ...
        genNav: function() {
            if (T.destroyNav(), $(".result-section").each(function(t, e) {
                var a = $(e),
        ...
        setNavPos: function() {
            ...
            e = f.offset().top;
            if (e > h - v && (h = e + v, this.setupPos()), t > h - l) {
                r.addClass("fixed");
                var a = window.pageXOffset || 0;
                r.css("left", -a)
            } else r.removeClass("fixed"),
            r.css("left", "")
        },
        setupPos: function() {
...
define("translation:widget/translate/details/collapse/collapse",
function(a, t, e) {
    "use strict";
    ...
    n = {
        ...
        bindEvent: function() {
            o.on("click", ".section-collapse-expand-btn",
            function() {
                var a = $(this),
                t = a.parent(".need-collapse"),
                e = t.attr("data-nav-text");
                if (t.hasClass("to-expand")) {
                    if (window._hmt.push(["_trackEvent", "首页", "47_首页页面_点击展开收起模块_" + e + "_展开"]), n.expandSection(t, a), t.hasClass("usecase-section")) {
                        var s = t.find(".cur"),
                        l = s.attr("data-tab-text");
                        window._hmt.push(["_trackEvent", "首页", "47_首页页面_点击展开收起模块_" + l + "_展开"])
                    }
                } else if (t.hasClass("to-collapse") && (window._hmt.push(["_trackEvent", "首页", "47_首页页面_点击展开收起模块_" + e + "_收起"]), n.collapseSection(t, a), t.hasClass("usecase-section"))) {
                    var o = t.find(".cur"),
                    i = o.attr("data-tab-text");
                    window._hmt.push(["_trackEvent", "首页", "78_首页页面_点击展开收起模块_" + i + "_收起"])
                }
            }),
            $(window).on("resize.reGenSampleCollapse",
            function() {
        ...
        expandSection: function(a, t) {
            if (a.hasClass("need-collapse")) {
                ...
                } else a.find(".section-collapse-expand-btn").attr("data-expand-top", "");
                if (a.hasClass("sample-section") && a.attr("data-last-collapse-status", "to-collapse"), !a.hasClass("to-expand")) return;
        ...
        collapseSection: function(a, t) {
            if (a.hasClass("need-collapse") && a.hasClass("to-collapse")) {
                var e = void 0,
                l = void 0;
                t.attr("data-expand-top") ? (e = parseInt(t.attr("data-expand-top"), 10), l = !0) : (e = t.offset().top - $(window).scrollTop(), l = !1);
                ...
                a.hasClass("usecase-section") && $(".oxford-items").length > 0 && ($(".oxford-items").addClass("hide"), $(".oxford-to-expand").removeClass("hide")),
                s.setupPos(),
                s.mockScrollingClickFlag(!0);
                var i = t.offset().top - e;
                if (!l) return window.scrollTo(0, i),
        ...
        genCollapse: function() {
            ...
            a.length > 0 && a.each(function() {
                var a = $(this);
                if ($('<a class="section-collapse-expand-btn" href="javascript:"></a>').appendTo(a), a[0].hasAttribute("data-collapse-height")) {
                    var t = parseInt(a.attr("data-collapse-height"), 10),
                    e = a.find(".details-cont-item");
                    e.height() > t && (a.removeClass("to-collapse").addClass("to-expand"), e.css("max-height", t + "px"))
                } else a.hasClass("sample-section") && n.setSampleCollapse(!1)
            })
        },
        setSampleCollapse: function(a) {
            ...
            var n = null;
            if (o.length > 5 && (l = !0, n = o.eq(5)), l) {
                var i = n.offset().top - e.offset().top;
                t.attr("data-collapse-height", i),
                "to-expand" === t.attr("data-last-collapse-status") ? (t.addClass("to-expand"), e.css("max-height", i + "px")) : "to-collapse" === t.attr("data-last-collapse-status") ? (t.addClass("to-collapse"), e.css("max-height", "none")) : (t.addClass("to-expand"), t.attr("data-last-collapse-status", "to-expand"), e.css("max-height", i + "px"))
            } else t.removeClass("to-collapse to-expand"),
...
define("translation:widget/translate/output/mouseover",
function(t, e) {
    "use strict";
    var i = (t("translation:widget/common/environment"), {
        ...
        isover: function(t) {
            ...
            o = s.left,
            r = s.top,
            n = t.text || i.attr("data-hover-tip-text"),
            a = $("#hover-tips"),
            l = i.attr("data-hover-tip-offset"),
            v = 0,
            h = 14;
            i.parents(".sample-output").length > 0 || i.parents("#zonedword-wrap").length > 0 || (this.overTarget = t.target, this.isOverFlag = !0, l && (e = l.split("|"), 2 === e.length ? (v = parseInt(e[0], 10), h = parseInt(e[1], 10)) : 1 === e.length && (v = parseInt(e[0], 10))), a.show().css({
                visibility: "hidden"
            }).find(".tips-content").text(n), o = o - a.outerWidth() / 2 + i.outerWidth() / 2 + v, r = r - a.outerHeight() / 2 - i.outerHeight() / 2 - h, a.offset({
                top: r,
                left: o
            }).css({
                visibility: "visible"
            }).show(), (i.hasClass("setting-btn") || i.hasClass("collection-btn")) && $("#hover-tips").css("top", -75))
        },
        isout: function() {
...
define("translation:widget/translate/details/dictionary/simplemeans",
function(t, e) {
    "use strict";
    function n(t) {
        t = Number(t);
    ...
    a.helper("uriComponentTrimAndEncode",
    function(t) {
    ...
    h = {
        buildSimpleMeans: function(t) {
            ...
            h = !1;
            if (("en" === u && "th" === p || "th" === u && "en" === p) && (d.tplData.show_th_detail = !0), d.tplData.show_sound = !1, ("en" === u || "zh" === u) && (d.tplData.show_sound = !0), e.tags) {
                var g = [];
            ...
            $(".simple-dict .op-repeat").length > 0 && (_hmt.push(["_trackEvent", "首页", "web端复读按钮出现次数"]), this.bindRepeatEvents())
        },
        bindEvents: function() {
            var t = this,
            e = !1,
            ...
            s = 0,
            c = 30;
            $(".translate-wrap").on("click", ".dictionary-wrap .op-sound",
            function() {
                t.timer && clearTimeout(t.timer),
                t.clickSound({
                    target: this
                })
            }).on("mouseenter", ".dictionary-wrap .op-sound",
            function() {
                t.isoverSound({
                    target: this
                })
            }).on("mouseleave", ".dictionary-wrap .op-sound",
            function() {
                t.isoutSound()
            }).on("click", ".dictionary-wrap .op-repeat",
            function() {
                t.repeatSound({
                    target: this
                })
            }).on("click", ".dictionary-wrap .dict-second-trans",
            function() {
                _hmt.push(["_trackEvent", "首页", "Web中英词典卡片发起二次翻译次数"])
            }).off("click.sound").on("click.sound", "a",
            function() {
                var e = $(this); (e.attr("href").match(/[\.\/]/g) || e.hasClass("collection-btn")) && t.shutdownAudio()
            }).on("click", ".dictionary-kingsoft-source-arrow,.dictionary-kingsoft-source-text,.dictionary-kingsoft-source-icon",
            function() {
                _hmt.push(["_trackEvent", "首页", "73_首页页面_点击金山词霸来源"]),
                window.open("http://www.iciba.com/", "_blank")
            }).on("click", ".dictionary-explain-video",
            function(t) {
            ...
            $(document).on("mouseup.dragVideo",
            function(t) {
                return 0 !== t.button ? void t.preventDefault() : void(e && (e = !1, $(".dictionary-wrap .video-container").removeClass("dragging"), $("body").off("mousemove.dragVideo")))
            })
        },
        ...
        repeatSound: function(t) {
            var e = this,
            n = $(t.target);
            if (n.hasClass("op-repeat-running")) i.isover({
                target: t.target,
                text: "复读"
            }),
            e.shutdownRepeat(),
            _hmt.push(["_trackEvent", "首页", "web端复读按钮停止点击"]);
                ...
                if (e.shutdownRepeat(), p = 8, n.addClass("op-repeat-running"), d = o.generateURI({
                    lan: n.attr("data-sound-lan"),
                    text: n.attr("data-sound-text")
                }), BTPM.setUrl(d), p--, i.isover({
                    target: t.target,
                    text: "停止复读"
                }), n.attr("data-hover-tip-text", "停止复读"), "IE" === BTPM.stage) {
                    var a = n.siblings("b").text();
                    if (a && a.length > 0) {
                        a = a.match(/\[(.*)\]/)[1];
                        var r = e.getRepeatDuration(a);
                        s = setInterval(function() {
                            return 1 > p ? void e.shutdownRepeat() : (BTPM.setUrl(d), void p--)
                        },
                        r)
                    }
                } else u = !0,
                $(BTPM).off("ended.repeating").on("ended.repeating",
                function() {
        ...
        shutdownRepeat: function(t) {
            ...
            "IE" === BTPM.stage ? clearInterval(s) : (clearTimeout(c), u = !1, $(BTPM).off("ended.repeating"))
        },
        ...
        bindRepeatEvents: function() {
            var t = this;
            $(".container").off("click.repeatthing").on("click.repeatthing", "a",
            function() {
                var e = $(this);
        ...
        translateStopRepeat: function() {
            return this.isNotInRepeating() ? !1 : (this.shutdownRepeat(), _hmt.push(["_trackEvent", "首页", "web端重新翻译停止复读"]), !0)
        },
...
define("translation:widget/translate/details/collins/collins",
function(t, e) {
    "use strict";
    function n(t) {
    ...
    function(t) {
        ...
        function(t, e) {
            ...
            } else n.push('<a href="/#en/zh/' + encodeURIComponent(e) + '" class="sec-trans">' + e + "</a>")
        }),
        n.join(";&nbsp; ")
    });
    var l = {
        buildCollins: function(t) {
            var e = t.data,
            o = {};
            if (e.menus) for (var a = e.menus.length,
            r = 0; a > r; r++) {
                var l = e.menus[r];
                if (l.entry) for (var u = l.entry.length,
                c = 1,
                d = 0; u > d; d++) {
                    var m = l.entry[d];
                    n(m) && (m.isValid = !0, m.idxid = c++)
                }
            } else if (e.entry) for (var v = e.entry.length,
            c = 1,
            r = 0; v > r; r++) {
                var l = e.entry[r];
                n(l) && (l.isValid = !0, l.idxid = c++)
            }
            o.tplData = e;
        ...
        bindEvents: function() {
            var t = this;
            $(".translate-wrap").on("click", ".collins-item .op-sound",
            function() {
                t.clickSound({
                    target: this
                })
            }).on("mouseenter", ".collins-item .op-sound",
            function() {
                t.mouseOverSound({
                    target: this
                })
            }).on("mouseleave", ".collins-item .op-sound",
            function() {
                t.mouseOutSound()
            })
        },
...
define("translation:widget/translate/output/adcards",
function(a, t) {
    "use strict";
    var e, r = (a("translation:widget/common/environment"), a("translation:widget/common/third_party/template")),
    n = a("translation:widget/common/cookie"),
    p = {
        bindEvents: function() {
            $(".translate-wrap").on("click", ".trans-ad-app-control",
            function() {
                var a = $(".trans-ad-app-wrap").hasClass("trans-ad-app-wrap-click") ? 1 : 0;
                $(".trans-ad-app-wrap").toggleClass("trans-ad-app-wrap-click"),
                _hmt.push(["_trackEvent", "首页", "web端二维码点击"]),
                0 === a && _hmt.push(["_trackEvent", "首页", "web端收拢APP二维码点击"]),
                1 === a && _hmt.push(["_trackEvent", "首页", "web端展开APP二维码点击"])
            }),
            $("#sideAdData").length > 0 ? (e = "sideAd", $(".translate-wrap").on("click", ".showad-close-btn",
            function(a) {
                $(".trans-side-ad-wrap").hide();
                var t = (new Date).getTime(),
                e = Math.floor(t / 864e5);
                n.setCookie("sideAdClose", e),
                _hmt.push(["_trackEvent", "首页", "web端侧边栏广告关闭点击"]),
                a.preventDefault(),
                a.stopPropagation()
            }).on("click", ".side-ad-link",
            function() {
                _hmt.push(["_trackEvent", "首页", "web端侧边栏图文广告链接点击"])
            })) : e = "appAd"
        },
        hideAppQr: function() {
            "appAd" === e ? $(".trans-ad-app-wrap").hide() : "sideAd" === e && $(".trans-side-ad-wrap").hide()
        },
        showAppQr: function(a) {
            if ($(".app-guide").length > 0 && !$(".app-guide").hasClass("app-guide-hide")) return void $(".trans-ad-app-wrap").hide();
            if ("appAd" === e) {
                if ($(".trans-ad-app-wrap").length <= 0) {
                    var t = r("tplAppQr");
                    $("#transOtherRight").append(t)
                }
                $(".trans-ad-app-wrap").show()
            } else if ("sideAd" === e) {
                if ($(".trans-side-ad-wrap").length > 0 && "block" === $(".trans-side-ad-wrap").css("display")) return;
                var p = n.getCookie("sideAdClose");
                if (p) {
                    p = parseInt(p, 10);
                ...
                if ($(".trans-side-ad-wrap").length <= 0) {
                    var d = $("#sideAdData"),
                    o = {
                        path: d.attr("data-path"),
                        url: d.attr("data-url"),
                        title: d.attr("data-title"),
                        showad: d.attr("data-showad") || 0
                    },
                    t = r("tplSideAd", o);
                    $("#transOtherRight").append(t),
                    _hmt.push(["_trackEvent", "首页", "web端侧边栏广告生成"])
                }
                $(".trans-side-ad-wrap").show(),
                _hmt.push(["_trackEvent", "首页", "web端侧边栏广告总展现"])
            }
            $(".trans-ad-app-wrap, .trans-side-ad-wrap").toggleClass("hot-link-middle-right", a)
        }
    };
    $(function() {
        p.bindEvents()
    }),
    t.hideAppQr = function() {
        p.hideAppQr()
    },
    t.showAppQr = function(a) {
        p.showAppQr(a)
    }
});;
define("translation:widget/translate/details/translator/translator",
function(t, n, e) {
    "use strict";
    ...
    u = {
        ...
        bindEvents: function() {
            var t = this;
            s.on("click", "#transTranslator .op-sound",
            function(n) {
                t.clickSound({
                    target: n.currentTarget
                })
            }).on("mouseenter", "#transTranslator .op-sound",
            function(n) {
                t.mouseOverSound({
                    target: n.currentTarget
                })
            }).on("mouseleave", "#transTranslator .op-sound",
            function() {
                t.mouseOutSound()
            })
        },
...
define("translation:widget/translate/details/festivalLink/festivalLink",
function(t, n, i) {
    "use strict";
    function e() {
        a()
...
define("translation:widget/translate/details/edict/edict",
function(t, e, n) {
    "use strict";
    var i = t("translation:widget/common/third_party/template"),
    o = t("translation:widget/translate/details/dictionary/simplemeans"),
    ...
    d = {
        bindEvents: function() {
            $(".translate-wrap").on("click", ".item-edict .op-sound",
            function(t) {
                d.clickSound({
                    target: t.currentTarget
                })
            }).on("mouseenter", ".item-edict .op-sound",
            function(t) {
                d.mouseOverSound({
                    target: t.currentTarget
                })
            }).on("mouseleave", ".item-edict .op-sound",
            function() {
                d.mouseOutSound()
            })
        },
...
define("translation:widget/translate/details/zdict/zdict",
function(t, a, e) {
    "use strict";
    function i(t) {
        var a = t.data,
...
define("translation:widget/translate/details/keywords/keywords",
function(t, e) {
    "use strict";
    var n = t("translation:widget/common/third_party/template"),
    i = t("translation:widget/common/environment"),
    ...
    o = {
        build: function(t) {
            ...
            h = !1,
            s = {};
            "zh" === a && "en" === d ? (h = !0, _hmt.push(["_trackEvent", "首页", "Web中英方向重点词汇卡片展现次数"]), s.direction = "zh2en") : (_hmt.push(["_trackEvent", "首页", "Web英中方向重点词汇卡片展现次数"]), s.direction = "en2zh"),
            $.each(o,
            function(t, e) {
...
define("translation:widget/translate/output/bottomBanner",
function(n, e) {
    "use strict";
    ...
    a = {
        ...
        sendIndexBannerLog: function(n) {
            var e = n && n.source,
            a = location.hash;
            $(".spread-slide a").length <= 0 || ("clear" === e ? _hmt.push(["_trackEvent", "web端翻译—banner总展现", "web端翻译—首屏banner展现"]) : a !== t.get("preHash") && (_hmt.push(["_trackEvent", "web端翻译—banner总展现", "web端翻译—首屏banner展现"]), t.set("preHash", a)))
        }
    };
...
define("translation:widget/translate/favo/favoHelper",
function(r, e) {
    "use strict";
    var t = {
        ...
        parseZonedWordResult: function(r) {
            var e, t = "";
            return 1 === r ? (e = $(".zonedword-result .dictionary-output"), t += e.html(), t = t.replace(/<(?!\/(div|p))[^<>]*>/gi, "").replace(/<\/(div|p)>/gi, "\r\n"), t = t.replace(/&gt;/gim, ">"), t = t.replace(/&lt;/gim, "<"), t = t.replace("详细释义>>", "")) : (e = $(".zonedword-result .output-bd").find(".target-output"), e.each(function() {
...
define("translation:widget/translate/favo/collInfo",
function(t, n, e) {
    "use strict";
    function r(t) {
        return function() {
        ...
        getDefaultGroupAsync: function() {
            ...
            return r(regeneratorRuntime.mark(function n() {
                ...
                return regeneratorRuntime.wrap(function(t) {
                    ...
                    case 0:
                        if (e = o.get("collInfo"), "number" == typeof e.defaultId) {
                            t.next = 6;
                            break
                        }
                        return t.next = 4,
        ...
        getCollGroupListAsync: function() {
            ...
            return r(regeneratorRuntime.mark(function n() {
                ...
                return regeneratorRuntime.wrap(function(t) {
                    for (;;) switch (t.prev = t.next) {
                    case 0:
                        if (e = o.get("collInfo"), 0 !== e.groupList.length) {
                            t.next = 7;
                            break
                        }
                        return t.next = 4,
...
;
define("translation:widget/translate/input/inputCollGroup/inputCollGroup",
function(n, o, t) {
    "use strict";
    ...
    y = {
        ...
        bindEvent: function() {
            ...
            p.keydown(function(n) {
                return 13 === parseInt(n.keyCode, 10) ? (n.preventDefault(), y.newGroupAndAddColl(), !1) : void 0
            }),
            h.on("click",
            function() {
                y.hide()
...
define("translation:widget/translate/zonedword/zonedCollGroup/zonedCollGroup",
function(o, n, t) {
    "use strict";
...
define("translation:widget/translate/favo/favo",
function(t, e, i) {
    "use strict";
    function n(t) {
    ...
    n.prototype = {
        ...
        bindEvent: function() {
            var t = this;
            this.$btn.on("click.favo",
            function() {
                var e = s.get("account");
                "" !== e.is_login ? (t.saved ? t.deleteItem() : c.getDefaultGroupAsync().then(function() {
                    var e = s.get("collInfo"); - 1 !== e.defaultId ? t.add(e.defaultId) : "input" === t.pos ? d.show() : "zonedword" === t.pos && "none" === $(".zoned-coll-extra-container").css("display") && u.show()
        ...
        favorIsSaved: function(t) {
            if (this.query === t.reqQurey && this.direction === t.reqDirection) {
                ...
                i || (e.attr("data-hover-tip-text", "已收藏"), r.isover({
                    target: e[0]
                }), setTimeout(function() {
                    r.isout()
                },
        ...
        favorIsNotSaved: function(t) {
            if (this.query === t.reqQurey && this.direction === t.reqDirection) {
                ...
                t.firstScreen && (e.attr("data-hover-tip-text", "已取消收藏"), r.isover({
                    target: e[0]
                }), setTimeout(function() {
                    r.isout(),
        ...
        add: function(t) {
            ...
            "input" === this.pos ? (e.fanyi_dst = a.parseNormalResult(), e.dict = this.dictJSON ? a.parseDictResult() : "", e.dict_json = this.dictJSON) : (e.type = this.type, e.fanyi_dst = a.parseZonedWordResult(this.type));
            var i = s.get("maxCollectionCount");
            if (this.query.length > i || e.fanyi_dst.length > i) return void alert("囧, 原文和译文要是在" + i + "字以下就好啦 ^_^");
                ...
                $.ajax({
                    ...
                    success: function(e) {
                        0 === e.errno ? (n.favorIsSaved({
                            ...
                            reqQurey: t,
                            reqDirection: i
                        }), "input" === n.pos ? d.hide() : "zonedword" === n.pos && u.hide(), n.trigger("change")) : n.favorIsNotSaved({
                            reqQurey: t,
                            reqDirection: i
                        })
                    }
        ...
        on: function(t, e) {
            return this.handles[t] && "[object Function]" === Object.prototype.toString.call(e) ? (this.handles[t].push(e), this) : void 0
        },
        off: function(t) {
...
define("translation:widget/translate/input/inputFavo",
function(t, n, a) {
    "use strict";
...
define("translation:widget/translate/details/sample/sample",
function(t, e) {
    "use strict";
    var a, n, l, i, s = t("translation:widget/common/third_party/template"),
    o = t("translation:widget/translate/details/dictionary/simplemeans"),
    r = t("translation:widget/common/soundURIGenerator"),
    u = t("translation:widget/common/environment"),
    g = $("#left-result-container"),
    d = ["《柯林斯高阶英汉双解学习词典》", "《汉英大词典》", "百度翻译例句库"],
    p = void 0,
    c = {
        buildSample: function(t) {
            ...
            var o = {};
            if (o.tplData = {},
            o.tplData.to_lang = n, e["double"] = e["double"].replace(/\\'/g, "'"), e.single = e.single.replace(/\\'/g, "'"), e["double"] = e["double"].replace(/[‘|’]/g, "'"), e.single = e.single.replace(/[‘|’]/g, "'"), e["double"]) {
            ...
            if (e.single) {
                ...
                e.senData2 = [];
                for (var u = 0,
                d = e.single.length; d > u; u++) {
                    var c, m = "";
                    "zh" === n ? c = e.single[u][0] : "en" === n && (c = e.single[u][1]);
                    for (var h = 0,
                    v = c.length; v > h; h++) m += c[h][0],
                    c[h][3] && (m += c[h][3]);
                    ...
                    } else e.single[u][2] = e.single[u][1],
                    e.single[u][1] = "#"
                }
            ...
            if (e.tag && e.tag instanceof Array) {
                var S = e.tag.length;
                S && S > 1 && (o.tplData.tag = e.tag, _hmt.push(["_trackEvent", "首页", "web端双语例句子TAB出现"]))
            }
            var D = s("tplSample", o);
            g.append(D)
        },
        getDoubleSample: function(t, e) {
            ...
            for (var l = !0,
            i = 0,
            s = a["double"].length; s > i; i++) {
                var o, r = ""; ! e && "zh" === n || e && "en" === n ? o = a["double"][i][0] : (!e && "en" === n || e && "zh" === n) && (o = a["double"][i][1]);
                for (var u = 0,
                g = o.length; g > u; u++) r += o[u][0],
                o[u][4] && (r += o[u][4]);
                r = encodeURIComponent(r),
                a.senData[i] = r,
                l && $.inArray(a["double"][i][2], d) < 0 && (a["double"][i].isFirstNetSt = !0, l = !1);
                var p = a["double"][i][2];
                if (/^https?\:\/\//.test(p)) {
                    p = p.replace(/^https?\:\/\//, "");
                    var c = p.indexOf("/");
                    a["double"][i][3] = c > 0 ? p.substr(0, c) : p
                } else a["double"][i][3] = a["double"][i][2],
                a["double"][i][2] = "#"
            }
            return a
        },
        bindEvents: function() {
            ...
            }).on("mouseenter", ".item-sample .op-sound",
            function() {
                t.mouseOverSound({
                    target: this
                })
            }).on("mouseleave", ".item-sample .op-sound",
            function() {
                t.mouseOutSound()
            ...
            }).on("click", ".sample-tagitem",
            function() {
                t.clickTagItem({
                    target: this
                })
            }).on("dblclick.sample", ".sample-wrap .sample-source, .sample-wrap .sample-target",
            function() {
                t.getHighlightQueryAndSave($(this))
            })
        },
...
define("translation:widget/translate/details/zhenDict/zhenDict",
function(t, a, e) {
    "use strict";
    function n(t) {
        var a = t.data,
...
define("translation:widget/translate/details/general/general",
function(a, t, e) {
    "use strict";
    function n(a) {
        var t = a.data,
...
define("translation:widget/translate/details/webMeans/webMeans",
function(t, e) {
    "use strict";
    var n = t("translation:widget/common/third_party/template"),
    a = t("translation:widget/common/util").getDisplayLength,
    ...
    r = {
        ...
        quickSort: function(t) {
            ...
            for (var e = [], n = [], a = t[0], i = 1; i < t.length; i++) t[i].pv < a.pv ? n.push(t[i]) : e.push(t[i]);
...
define("translation:widget/translate/details/oxford/oxfordEntryAdapter",
function(t, n, a) {
    "use strict";
    var e = {
        init: function(t) {
            if (t.entry && 0 !== t.entry.length) {
                ...
                function(t, n) {
                    ...
                    $.each(n.data,
                    function(t, a) {
                        return "p-g" === a.tag ? (n.hasPG = "y", !1) : void 0
                    })
                })
            }
        }
...
define("translation:widget/translate/details/oxford/oxfordUnboxAdapter",
function(a, t, o) {
    "use strict";
    var n = {
        init: function(a, t) {
            if (!a.unbox || 0 === a.unbox.length) return void(a.unbox = "");
            var o = {
                synonyms: 0,
                synald7: 0,
                which_word: 0,
...
define("translation:widget/translate/details/oxford/oxfordTemplateHelper",
function(t) {
    "use strict";
    ...
    e.helper("encodeURIComponent",
    function(t) {
        return encodeURIComponent(t)
    }),
    e.helper("addSpaceAroundMark",
    function(t, e) {
        var a = new RegExp("(" + e + ")", "g");
        return t.replace(a, " $1 ")
    }),
    e.helper("setParaOudent",
    function(t, e) {
        if ("synald7" === e || "n" === t.outdent) return "";
        if ("para" !== t.tag) return "";
        if (!t.data) return "";
        var a = !1;
        return $.each(t.data,
        function(t, e) {
            return "und" === e.tag ? (a = !0, !1) : void 0
        }),
        a ? "unbox-outdent-und": "unbox-outdent-unx"
    }),
    e.helper("setNoteOudent",
    function(t) {
        if ("unnote" !== !t.tag) return "";
        if (!t.data) return "";
        var e = 0;
        return $.each(t.data,
        function(t, a) {
    ...
    e.helper("getIdsgHtml",
    function(t) {
        var a = {
            tag: "ids-g",
            data: []
        };
        if ("xrs" === t.tag ? $.each(t.data,
        function(t, e) {
            e.data && a.data.push(e)
        }) : $.each(t.data,
        function(t, e) {
            "id-g" === e.tag ? a.data.push(e) : $.each(e.data,
            function(t, e) {
                e.data && a.data.push(e)
            })
        }), 0 === a.data.length) return "";
    ...
    e.helper("judgeIfG",
    function(t) {
        if ("alone" !== t.tag || !t.data || 0 === t.data.length) return "";
        var e = t.data[0];
        if ("info" !== e.tag || !e.data || 0 === e.data.length) return "";
        var a = e.data[0];
        return "g" === a.tag ? "entry-vsg-label-hide": ""
    }),
    e.helper("judgeIfCo",
    function(t) {
        if ("if-g" !== t.tag || !t.data || 0 === t.data.length) return "";
        var e = t.data[0];
        if ("alone" !== e.tag || !e.data || 0 === e.data.length) return "";
        var a = e.data[0];
        if ("info" !== a.tag || !a.data || 0 === a.data.length) return "";
        var n = a.data[0];
...
define("translation:widget/translate/details/oxford/oxford",
function(t, e, n) {
    "use strict";
    var o = t("translation:widget/common/third_party/template"),
    r = t("translation:widget/common/soundURIGenerator"),
    ...
    l = {
        ...
        bindEvents: function() {
            var t = this;
            $(".translate-wrap").on("click", ".item-oxford .op-sound",
            function(e) {
                t.clickSound({
                    target: e.currentTarget
                })
            }).on("mouseenter", ".item-oxford .op-sound",
            function(e) {
                t.mouseOverSound({
                    target: e.currentTarget
                })
            }).on("mouseleave", ".item-oxford .op-sound",
            function() {
                t.mouseOutSound()
            })
        },
...
function(t, n, e) {
    ...
    r = t("translation:widget/common/environment"),
    s = $("#left-result-container");
    o.helper("synonymOffBrackets",
    function(t) {
        return t.replace(/\〈([^\〉]+)\〉/, "$1")
    }),
    o.helper("synonymFrontQuery",
    function(t) {
    ...
    var u = {
        ...
        bindEvents: function() {
            var t = this;
            $(".translate-wrap").on("click", ".synonym-item .op-sound",
            function() {
                t.clickSound({
                    target: this
                })
            }).on("mouseenter", ".synonym-item .op-sound",
            function() {
                t.mouseOverSound({
                    target: this
                })
            }).on("mouseleave", ".synonym-item .op-sound",
            function() {
                t.mouseOutSound()
            })
        },
...
define("translation:widget/translate/details/rootsaffixes/rootsaffixes",
function(t, a, s) {
    "use strict";
    var e = t("translation:widget/common/third_party/template"),
    ...
    i = {
        ...
        bindEvents: function() {
            n.on("click", ".ras-collapse-expand-btn",
            function() {
...
define("translation:widget/translate/details/usecase/usecaseTemplateHelper",
function(e) {
    "use strict";
    ...
    t.helper("encodeURIComponent",
    function(e) {
        return encodeURIComponent(e)
    }),
    t.helper("addSpaceAroundMark",
    function(e, t) {
        var a = new RegExp("(" + t + ")", "g");
        return e.replace(a, " $1 ")
    }),
    t.helper("setParaOudent",
    function(e, t) {
        if ("synald7" === t || "n" === e.outdent) return "";
        if ("para" !== e.tag) return "";
        if (!e.data) return "";
        var a = !1;
        return $.each(e.data,
        function(e, t) {
            return "und" === t.tag ? (a = !0, !1) : void 0
        }),
        a ? "unbox-outdent-und": "unbox-outdent-unx"
    }),
    t.helper("setNoteOudent",
    function(e) {
        if ("unnote" !== !e.tag) return "";
        if (!e.data) return "";
        var t = 0;
        return $.each(e.data,
        function(e, a) {
    ...
    t.helper("splitTextByMark",
    function(e, t) {
        if (e = $.trim(e), !e) return "";
        e = a.encodeHTML(e);
        var n = e.split(t),
        r = n.length,
        u = [];
    ...
    function(e) {
        if ("alone" !== e.tag || !e.data || 0 === e.data.length) return "";
        var t = e.data[0];
        if ("info" !== t.tag || !t.data || 0 === t.data.length) return "";
        var a = t.data[0];
        return "g" === a.tag ? "entry-vsg-label-hide": ""
    }),
    t.helper("judgeIfCo",
    function(e) {
        if ("if-g" !== e.tag || !e.data || 0 === e.data.length) return "";
        var t = e.data[0];
        if ("alone" !== t.tag || !t.data || 0 === t.data.length) return "";
        var a = t.data[0];
        if ("info" !== a.tag || !a.data || 0 === a.data.length) return "";
    ...
    function(e) {
        ...
        if ($.each(e.data,
        function(e, t) {
            "id-g" === t.tag ? ($.each(t.data,
            function(e, n) {
                "xrs" === n.tag && "id" === n.xt && ($.each(n.data,
                function(e, t) {
                    t.data && a.data.push(t)
                }), t.data.splice(e, 1))
            }), a.data.push(t)) : $.each(t.data,
            function(e, t) {
                t.data && a.data.push(t)
            })
        }), 0 === a.data.length) return "";
...
define("translation:widget/translate/details/usecase/usecase",
function(e, t, a) {
    "use strict"; {
    ...
    c = {
        ...
        bindEvents: function() {
            var e = this;
            d.on("click", ".usecase-section .op-sound",
            function(t) {
                e.clickSound({
                    target: t.currentTarget
                })
            }).on("mouseenter", ".usecase-section .op-sound",
            function(t) {
                e.mouseOverSound({
                    target: t.currentTarget
                })
            }).on("mouseleave", ".usecase-section .op-sound",
            function() {
                e.mouseOutSound()
            }).on("click", ".usecase-nav li",
            function(t) {
                e.changeTab({
                    target: t.currentTarget
                })
            }).on("click", ".item-usecase .oxford-to-expand",
            function(t) {
                e.showOxford({
                    target: t.currentTarget
                })
            }).on("click", ".item-usecase .oxford-to-collapse",
            function() {
                e.collapseOxford()
            })
        },
        ...
        changeTab: function(e) {
            ...
            if (!t.hasClass("cur")) {
                ...
                i.setupPos(),
                r && (r.hasClass("oxford-phrasalverb-only") ? this.hideOxford(!1) : (this.hideOxford(!0), $(".oxford-to-collapse").addClass("hide"))),
                window.scrollTo(0, a)
            }
        },
        genCollapse: function(e) {
            ...
            if (t[0].hasAttribute("data-collapse-height")) {
                ...
                s.height() > a ? (t.removeClass("to-collapse").addClass("to-expand"), s.css("max-height", a + "px")) : t.removeClass("to-expand").removeClass("to-collapse")
            }
        },
        ...
        hideOxford: function(e) {
            e && ($(".oxford-items").addClass("hide"), $(".oxford-to-expand").removeClass("hide"))
        },
        collapseOxford: function() {
            this.hideOxford(!0);
            var e = parseInt($(".oxford-to-expand").attr("data-expand-top"), 10),
            t = ($(".oxford-to-collapse").offset().top, $(".oxford-to-collapse").offset().top - e);
...
define("translation:widget/translate/details/sanyms/sanyms",
function(n, t, a) {
    "use strict";
    var e = n("translation:widget/common/third_party/template"),
    r = $("#left-result-container");
    e.helper("uriComponentTrimAndEncode",
    function(n) {
...
define("translation:widget/translate/details/etym/etym",
function(t, a, e) {
    "use strict";
    var n = t("translation:widget/common/third_party/template"),
    i = $("#left-result-container"),
...
define("translation:widget/translate/details/details",
function(e, a, t) {
    "use strict";
    function s(a, t, s, j, N) {
        var O = null,
        C = null,
        E = null,
        I = "",
        ...
        function() {
            if (!a.dict_result || "en" !== s && "zh" !== s && "jp" !== s && "th" !== s) O = !1,
            k.sendIndexBannerLog();
            else if (a.dict_result.content) N || (O = a.dict_result, I = JSON.stringify(a.dict_result));
            else if (a.dict_result.simple_means && !N && (O = a.dict_result.simple_means, C = a.dict_result.baike_img_url, E = a.dict_result.queryExplainVideo, a.dict_result.simple_means.symbols && a.dict_result.simple_means.symbols.length > 0 && (I = JSON.stringify({
                simple_means: {
                    symbols: a.dict_result.simple_means.symbols
                }
            })), a.dict_result.sim_words && (O.sim_words = a.dict_result.sim_words), a.dict_result.net_means && (O.net_means = a.dict_result.net_means)), "zh" === t && "en" === s || "en" === t && "zh" === s) for (var e in a.dict_result) if (a.dict_result[e] instanceof Object && !$.isEmptyObject(a.dict_result[e]) && 0 !== a.dict_result[e].length) switch (e) {
            case "collins":
                q.collins = !0;
                break;
            ...
            case "general_knowledge":
                a.dict_result.general_knowledge.similar_words && (q.wordColl = !0);
                break;
            case "netdata":
                q.webMeaning = !0;
                break;
            ...
            q.simpleMeaning = Boolean(O),
            !a.liju_result || "en" !== s && "zh" !== s || !a.liju_result["double"] && !a.liju_result.single || (q.illSen = !0),
            a.trans_result && a.trans_result.keywords && a.trans_result.keywords.length > 0 && ("zh" === t && "en" === s || "en" === t && "zh" === s) && !q.simpleMeaning && (q.keyWord = !0),
            a.simworks && "[object Object]" === Object.prototype.toString.call(a.simworks) && (q.translator = !0)
        } ();
        var B = [],
        F = !1; !
        function() {
            if (e("translation:widget/translate/sideNav/navSorter/listOperator").getNavList().forEach(function(e) {
                var a = W[e];
                q[a] && B.push(a)
            }), q.festivalLink || q.adLink) {
                var a = [];
                q.festivalLink && a.push("festivalLink"),
                q.adLink && a.push("adLink"),
                "simpleMeaning" !== B[0] ? (B.unshift.apply(B, a), q.adLink && q.festivalLink && (F = !0)) : B.splice.apply(B, [1, 0].concat(a))
            }
            var t = B.find(function(e) {
                return "festivalLink" !== e && "adLink" !== e
            });
            n.set("firstModuleId", parseInt(Object.keys(W).find(function(e) {
                return W[e] === t
            }), 10))
        } ();
        var D = a.dict_result;
        ...
        "en" === t && "zh" === s || "zh" === t && "en" === s ? (y.genCollapse(), f.genNav()) : f.destroyNav()
    } {
        ...
        d = e("translation:widget/translate/details/dictionary/simplemeans"),
        ...
        k = e("translation:widget/translate/output/bottomBanner"),
        b = e("translation:widget/translate/input/inputFavo"),
        f = e("translation:widget/translate/sideNav/sideNav"),
        y = e("translation:widget/translate/details/collapse/collapse"),
        w = e("translation:widget/translate/details/sample/sample"),
        g = e("translation:widget/translate/details/collins/collins"),
...
define("translation:widget/translate/input/uploader",
function(e, t, o) {
    "use strict";
    var i = e("translation:widget/common/third_party/webuploader/webuploader.fis"),
    n = (e("translation:widget/common/environment"), i.create({
...
define("translation:widget/translate/docTranslate/docTransUtil",
function(e, t) {
    "use strict";
    var n = e("translation:widget/translate/input/uploader"),
    o = e("translation:widget/common/environment"),
    a = $(".doc-trans-view-wrap .progress-bar"),
    i = $(".doc-trans-view-wrap"),
    r = i.find(".src-doc-padding-wrapper, .dst-doc-padding-wrapper"),
    s = i.find(".export-tip"),
    d = i.find(".doc-async-translating-tip"),
    l = $("#doc-view-iframe"),
    c = /^\/docViewMode\?name=(.+)&from=(\w+)&to=(\w+)&token=(\w+)$/,
    p = {
        file: null,
        fileName: "",
        from: "",
    ...
    t.isSupportByDocTrans = function(e) {
        return "application/msword" === e || "application/vnd.openxmlformats-officedocument.wordprocessingml.document" === e || window.common.pdfHit && "application/pdf" === e || "application/vnd.ms-excel" === e || "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" === e || "application/vnd.ms-powerpoint" === e || "application/vnd.openxmlformats-officedocument.presentationml.presentation" === e
    },
    t.currTask = p;
    var m = {
        percentage: 0,
        uploadSuccess: function() {
            this.percentage = 30,
            a.css("transform", "scaleX(" + this.percentage / 100 + ")")
        },
        reset: function() {
            this.percentage = 0,
            a.removeAttr("style")
        ...
        add: function() {
            this.percentage + 30 < 95 && (this.percentage = this.percentage + 30, a.css("transform", "scaleX(" + this.percentage / 100 + ")"))
        },
        complete: function() {
            this.percentage = 100,
            a.css("transform", "scaleX(" + this.percentage / 100 + ")")
    ...
    t.clearDocTrans = function(e) {
        ...
        $(".doc-trans-file").text(""),
        window.common.docHit && !o.get("isInRtTransState") && 0 === $("#baidu_translate_input").val().length && ($("#upload-btn").show(), window.hasStatUploadBtnShow || (_hmt.push(["_trackEvent", "首页", "74_首页页面_上传文档按钮展示"]), window.hasStatUploadBtnShow = !0)),
        p.file && n.cancelFile(p.file),
        p.fileName = "",
        p.from = "",
        p.to = "",
        p.token = "",
        p.translatingParaIdxSet.clear(),
        delete p.translatedSpanCounter,
        delete p.detectedFrom,
        delete p.detectedTo,
        delete p.isOverflow,
        delete p.isOriginalOverflow,
        delete p.url,
        delete p.isHtml;
...
define("translation:widget/translate/docTranslate/docTranslate",
function(t, n, e) {
    "use strict";
    function r(t) {
        return function() {
    ...
    function o() {
        ...
        e = t.to,
        r = t.fileName;
        y.find(".file-name").text(r);
        var a = "auto" === n && "auto" === e;
        y.find(".doc-view-from-lang").text(a ? "中英互译": window.common.langList[n]),
        y.find(".doc-view-to-lang").text(a ? "": window.common.langList[e]),
        y.find(".doc-view-lang-pair").toggleClass("auto", a),
        b.show(),
        _.hide(),
        y.addClass("loading"),
        O = null
    ...
    function s() {
        return new Promise(function(t, n) {
            $.ajax({
                ...
                success: function(e) {
                    if (10010 === e.errno || 0 === e.errno) t(e);
                    else switch (e.errno) {
                    case 10020:
                        n({
                            content:
    ...
    function d(t) {
        ...
        if (n) {
            ...
            O = $(".doc-whole-container .translated-span"),
            l(),
            r && m(),
            window._hmt.push(["_trackEvent", "首页", "文档翻译_结果页展现，成功展示原文译文对照"]),
            h()
        } else z.attr("src", "https://view.officeapps.live.com/op/embed.aspx?src=" + T.currTask.url)
    }
    function l() {
        $("#doc-fill-div").remove();
        var t = I.height(),
        ...
        e = Math.abs(t - n),
        r = n > t ? I: H,
        a = $('<div style="height: ' + e + 'px" id="doc-fill-div"></div>');
        r.append(a)
    }
    function u(t) {
        t.stopPropagation(),
        D.hasClass("generating") || (T.currTask.isHtml && T.currTask.isOriginalOverflow && !localStorage.getItem("doNotTipExportOverflow") ? (window._hmt.push(["_trackEvent", "首页", "77_首页页面_导出提示展示"]), L.show()) : k())
    }
    function f() {
        return new Promise(function(t, n) {
            $.ajax({
        ...
        if (Array.isArray(e)) {
            ...
            g().then(function(t) {
                ...
                if ($("#main-outer").hasClass("doc-trans-view-mode")) {
                    var r = !1;
                    if (n) {
                        var a = e.translatedSpanCounter,
                        o = e.fromLang,
                        i = e.toLang,
                        s = e.isOverflow;
                        r = s,
                        Object.assign(T.currTask, {
                            translatedSpanCounter: a,
                            detectedFrom: o,
                            detectedTo: i,
                            isOverflow: s,
                            isOriginalOverflow: r
                        })
                    } else {
                        var c = e;
                        Object.assign(T.currTask, {
                    ...
                    b.removeAttr("style"),
                    _.removeAttr("style"),
                    y.removeClass("loading").addClass("viewing-" + (n ? "html": "file")),
                    d({
                        isHtml: n,
                        data: e,
                        isOriginalOverflow: r
    ...
    function m() { [I, H].forEach(function(t) {
    ...
    var w = function() {
        function t(t, n) {
            ...
            o = void 0;
            try {
                for (var i, s = t[Symbol.iterator](); ! (r = (i = s.next()).done) && (e.push(i.value), !n || e.length !== n); r = !0);
            } catch(c) {
                a = !0,
                o = c
            } finally {
    ...
    g = function() {
        var t = r(regeneratorRuntime.mark(function n() {
            var t, e, r, o;
            return regeneratorRuntime.wrap(function(n) {
                ...
                case 14:
                    return o = !0,
                    "string" != typeof r.data && (o = !1),
                    n.abrupt("return", {
                        isHtml: o,
                        data: o ? JSON.parse(r.data) : r.data.url
                    });
                case 19:
                    t -= e / 1e3,
                    tn.add();
    ...
    k = function() {
        var t = r(regeneratorRuntime.mark(function n() {
            ...
            return regeneratorRuntime.wrap(function(n) {
                for (;;) switch (n.prev = n.next) {
                case 0:
                    if (window._hmt.push(["_trackEvent", "首页", "82_首页页面_开始导出"]), !D.prop("data-has-gen-link")) {
                        n.next = 6;
                        break
                    }
                ...
                case 10:
                    ...
                    return D.removeClass("generating").prop("data-has-gen-link", !0),
                    window.location.href = "https://fanyi-doc.baidu.com/doctrans/download?fileToken=" + T.currTask.token,
                    window._hmt.push(["_trackEvent", "首页", "83_首页页面_成功导出"]),
                    n.abrupt("return");
                case 18:
    ...
    y = (t("translation:widget/common/third_party/md5"), $(".doc-trans-view-wrap")),
    b = y.find(".loading-container"),
    _ = y.find(".loading-err-container"),
    C = y.find(".err-title"),
    E = y.find(".err-content"),
    O = null,
    S = y.find(".doc-whole-container"),
    j = y.find(".src-doc-scroll-wrapper,.dst-doc-scroll-wrapper"),
    P = y.find(".src-doc-scroll-wrapper"),
    A = y.find(".dst-doc-scroll-wrapper"),
    I = y.find(".src-doc-padding-wrapper"),
    H = y.find(".dst-doc-padding-wrapper"),
    R = y.find(".loading-exit-btn"),
    q = y.find(".err-exit-btn"),
    M = y.find(".err-re-upload-btn"),
    N = y.find(".view-re-upload-btn"),
    D = y.find(".export-doc-btn"),
    L = y.find(".export-tip"),
    U = y.find(".no-tip-check"),
    F = y.find(".confirm-export-btn"),
    G = y.find(".view-file-name"),
    z = $("#doc-view-iframe"),
    J = y.find(".doc-async-translating-tip"),
    V = y.find(".go-back"),
    W = 0,
    B = 0,
    K = 120,
    ...
    $.fn.scrollEnd = function(t) {
        ...
        $(this).scroll(function(e) {
            var r = $(this);
            return r.is(P) && Z ? void(Z = !1) : (r.data("scrollTimeout") && clearTimeout(r.data("scrollTimeout")), void r.data("scrollTimeout", setTimeout(function() {
                t(e),
                r.data("scrollTimeout", 0)
            },
            n)))
        })
    };
    ...
    function() {
        ...
        function(t, n) {
            if (0 === n.errno) {
                var e = n.fileToken,
                r = T.currTask.file.name,
                a = T.currTask,
                o = a.from,
                i = a.to;
                location.hash = "/docViewMode?name=" + encodeURIComponent(r) + "&from=" + o + "&to=" + i + "&token=" + encodeURIComponent(e)
            } else c(10009 === n.errno ? {}: {
                content: "网络不给力，请稍后重试"
            })
        }),
        x.on("uploadError",
        ...
        R.add(q).on("click",
        function(t) {
            $(t.currentTarget).is(R) ? window._hmt.push(["_trackEvent", "首页", "文档翻译_loading点击退出按钮"]) : $(t.currentTarget).is(q) && window._hmt.push(["_trackEvent", "首页", "文档翻译_文档解析失败点击退出按钮"]),
            location.hash = "",
            T.clearDocTrans(!1)
        }),
        M.add(N).on("click",
        function(t) {
            $(t.currentTarget).is(N) ? window._hmt.push(["_trackEvent", "首页", "76_首页页面_点击上传新文档按钮"]) : $(t.currentTarget).is(M) && window._hmt.push(["_trackEvent", "首页", "文档翻译_文档解析失败点击重新上传"]),
            location.hash = "",
            T.clearDocTrans(!0)
        }),
        D.on("click", u),
        ...
        U.on("click",
        function() {
            U.hasClass("checked") || window._hmt.push(["_trackEvent", "首页", "78_首页页面_选中导出提示中不再提示复选框"]),
            U.toggleClass("checked")
        }),
        F.on("click",
        function() {
            window._hmt.push(["_trackEvent", "首页", "79_首页页面_点击导出提示中确认导出"]),
            U.hasClass("checked") && localStorage.setItem("doNotTipExportOverflow", "true"),
            L.hide(),
            k()
        }),
        $(window).on("click",
        function() {
            "none" !== L.css("display") && L.hide()
        }),
        V.on("click",
        function() {
            location.href = T.currTask.file ? "/#/docTransMode": "/"
        }),
        S.on("mouseenter", "span.translated-span",
        function(t) {
            ...
            a = null,
            o = null;
            P.find(n).length > 0 ? (r = P, a = A) : (r = A, a = P),
            o = a.find(".translated-span[data-span-idx='" + e + "']"),
            ...
            a.scrollTop(a.scrollTop() + l);
                ...
                var u = i - c;
                u > 0 && (a.is(P) && (Z = !0), a.scrollTop(a.scrollTop() - u))
            }
        }),
        S.on("mouseleave", "span.translated-span",
        function() {
            O.removeClass("hover")
        }),
        P.scrollbar(),
        ...
        function(t) {
            if (0 !== O.length) {
                var n = $(t.currentTarget);
                if (n.is(":hover")) {
                    var e = n.hasClass("src-doc-scroll-wrapper") ? A: P,
                    r = 0,
                    a = -1,
                    ...
                    d = 0;
                    do {
                        var l = o.eq(d++), u = l.offset().top - i;
                        u > 0 && (s = l, s.is(".not-translated-para") && (c = !1), r = u, a = l.attr(c ? "data-span-idx": "data-para-idx"))
                    } while ( null === s && d < o . length );
                    if ( - 1 !== a) {
                        var f = e.find("[" + (c ? "data-span-idx": "data-para-idx") + "='" + a + "']"),
                        p = W + r - f.offset().top;
        ...
        P.scrollEnd(function() {
            ...
            if ($("#main-outer").hasClass("doc-trans-view-mode") && T.currTask.isOverflow) {
                var n = P.find(".not-translated-para"),
                e = null,
                r = [],
                a = [],
                o = [],
                ...
                do {
                    c = n.eq(s++);
                    var f = c.offset().top, p = f + c.height(), h = p - W;
                    u = f - W, d = u >= B * Y, T.currTask.translatingParaIdxSet.has(c.attr("data-para-idx")) || d || (h > 0 ? e = c: u > -(B * X) && t(c, !1))
                } while ( null === e && s < n . length && ! d );
                if (null !== e) {
                    var m = function() {
                    ...
                    for (B > u && J.show(), o.forEach(function(t) {
                        return T.currTask.translatingParaIdxSet.add(t)
                    }), s -= 1; s < n.length; s++) {
                        var w = n.eq(s);
                        if (t(w, !0), i > 3e4) break
                    }
                    var g = a.join("\n"),
                    k = Date.now().toString(),
                    x = T.currTask,
                    ...
                    $.ajax({
                        ...
                        success: function(t) {
                            if ($("#main-outer").hasClass("doc-trans-view-mode")) {
                                if (m(), 0 !== t.errno) return void J.hide();
                                var n = [];
                                t.trans.forEach(function(t) {
                                    for (var e = 0; e < t.prefixWrap; e++) n.push(null);
                                    n.push({
                                        srcArray: t.src_array,
                                        dstArray: t.dst_array
                                    })
                                });
                                for (var e = a.length - n.length,
                                i = 0; e > i; i++) n.push(null);
                                r.forEach(function(t, e) {
                                    var r = A.find("[data-para-idx='" + o[e] + "']"),
                                    a = n[e],
                                    i = t.add(r);
                                    if (i.removeClass("not-translated-para"), i.removeAttr("data-para-idx"), null === a) i.text("");
                                    else {
                                        var s = a.srcArray,
                                        c = a.dstArray,
                                        d = t,
                                        ...
                                        s.forEach(function(t, n) {
                                            ...
                                            d.text(t),
                                            l.text(e),
                                            r.addClass("translated-span");
                                            var a = T.currTask.translatedSpanCounter++;
                                            if (r.attr("data-span-idx", a), n < s.length - 1) {
                                                var o = d.clone(),
                                                i = l.clone();
                                                d.after(o),
                                                l.after(i),
                                ...
                                l(),
                                0 === P.find(".not-translated-para").length && (T.currTask.isOverflow = !1),
                                O = S.find(".translated-span"),
                                J.hide()
                            }
                        },
                        error: function() {
        ...
        $(window).on("resize.adjustDocHeight",
        function() {
            $("#main-outer").hasClass("doc-trans-view-mode") && y.hasClass("viewing-html") && (l(), h())
        }),
        $(p)
    } (),
    e.exports = {
...
define("translation:widget/translate/docTransLang/docTransLang",
function(t) {
    "use strict";
    function o(t) {
        var o = a(t),
        ...
        l.filter('[data-dir="' + t + '"]').addClass("selected");
        var e = "auto2auto" === t;
        d.toggleClass("auto", e),
        e ? d.find(".from-doc-lang").text("中英互译") : (d.find(".from-doc-lang").text(window.common.langList[n]), d.find(".to-doc-lang").text(window.common.langList[r])),
        s.removeClass("open"),
        f.from = n,
        f.to = r
    }
    ...
    function n() {
        i.removeClass("guiding"),
        localStorage.setItem("docTransLangGuideFlag", "true")
    }
    var r = t("translation:widget/translate/input/uploader"),
    e = t("translation:widget/translate/docTranslate/docTransUtil"),
    i = $(".doc-trans-operation"),
    s = $(".doc-trans-dir"),
    d = s.find(".curr-doc-dir"),
    c = s.find(".doc-lang-select"),
    l = c.find(".doc-lang-pair"),
    u = c.find(".know-btn"),
    f = {
        from: "auto",
        to: "auto"
    ...
    function() {
        ...
        a && o(a),
        $(".doc-trans-btn").on("click",
        function() {
            r.option("formData", f),
            r.upload(e.currTask.file),
            Object.assign(e.currTask, f);
            ...
            "auto" === f.from && "auto" === f.to && window._hmt.push(["_trackEvent", "首页", "81_首页页面_点击文档翻译的翻译按钮时语言方向为中英互译"])
        }),
        d.on("click",
        function() {
            s.toggleClass("open"),
...
define("translation:widget/translate/input/sameHeightHandler",
function(t, e) {
    "use strict";
    var n = {};
    n.dom = {
    ...
    n.sameHeight = function() {
        ...
        if (t.$intputContent.css(e, 0), t.$outputContent.css(e, 0), t.$outputWrap.removeAttr("style"), $(".output-blank").get(0) && !$(".dictionary-wrap").get(0)) return void t.$outputWrap.outerHeight(t.$inputWrap.outerHeight() + 2);
        var n = 55,
        u = 61,
        ...
        if (! (139 > a && 139 > i)) {
            var r = a - i;
            switch (!0) {
            case r > 0 : t.$outputContent.css(e, r + "px");
                break;
            case 0 > r: t.$intputContent.css(e, -r + "px")
            }
        }
    },
...
define("translation:widget/translate/output/transCB",
function(t, n) {
    "use strict";
...
define("translation:widget/translate/output/jpHandler",
function(t, e) {
    "use strict";
    var n = (t("translation:widget/common/environment"), t("translation:widget/common/string")),
    r = {
        execData: function(t) {
            this.hasJpPinyin = !1;
            for (var e = t.length,
            n = 0; e > n; ++n) if (t[n].result && t[n].result.length > 0) {
                this.hasJpPinyin = !0;
                break
            }
        },
            ...
            for (var e = [], r = t.length, a = 0; r > a; ++a) {
                ...
                o = t[a].result.length; o >= c; c++) {
                    ...
                    if (c === o) {
                        ...
                        if (s = 0 === a ? t[a].result[c][2][0] : t[a].result[c][4][0], p = parseInt(s.split("|")[0], 10), f = parseInt(s.split("|")[1], 10) + p, p !== i) {
                            var h = n.cutByByte(u, i, p),
                            g = {
                                src: h,
                                dst: ""
...
define("translation:widget/translate/output/lmHandler",
function(t, a) {
    "use strict";
    var r = (t("translation:widget/common/environment"), {
        execData: function(t) {
            ...
            n = t.length;
            a[r] = [];
            for (var e = 0; n > e; e++)" " !== t[e].src_str && (" " !== t[e].trg_str && (this.hasLmData = !0), "\n" === t[e].src_str ? a[++r] = [] : a[r].push({
                src: t[e].src_str,
                trg: t[e].trg_str
            }));
            this.lmDataNew = a
...
define("translation:widget/translate/output/correctResult/correctResult",
function(t, e, o) {
    "use strict";
    ...
    d = {
        ...
        bindEvents: function() {
            var t = this;
            $(".output-wrap").on("click", ".op-correct",
            function() {
                t.showCorrectModel()
            }),
            u.on("click", ".output-correct-btn-close",
            function(e) {
                e.preventDefault(),
                t.hideCorrectModel()
            }).on("change", ".output-correct-type-box input",
            function() {
                t.verifyInput()
            }).on("click", ".output-correct-btn-submit",
            function(e) {
                e.preventDefault(),
        ...
        verifyInput: function() {
            ...
            return e.length > 0 && $.each(e,
            function(e, o) {
                var r = $(o);
                return r.prop("checked") ? (t = !0, !1) : void 0
            }),
        ...
        sendCorrectResult: function() {
            ...
            return l ? void $.ajax({
                ...
                data: e,
                success: function(e) {
                    return e ? e && 0 === e.errno ? (n.show("感谢反馈，您的反馈将用于提高翻译质量。"), void t.hideCorrectModel()) : e && 0 !== e.errno ? void n.show(e.errmsg) : void n.show("网络不可用，提交失败。") : void n.show("网络不可用，提交失败。")
                },
                error: function() {
                    n.show("网络不可用，提交失败。")
                }
            }) : (n.show("感谢反馈，您的反馈将用于提高翻译质量。"), void this.hideCorrectModel())
        },
        ...
        getOriResult: function() {
            for (var t = "",
            e = $("#original-output").find("p"), o = 0, r = $(e).length; r > o; o++) t += $(e).eq(o).text() + (o === r - 1 ? "": "\r\n");
            return t
        },
        resetModel: function() {
...
define("translation:widget/translate/output/editTips",
function(t, a) {
    "use strict";
    var e = (t("translation:widget/common/environment"), t("translation:widget/common/string")),
    i = [],
    n = {
        bindEvents: function() {
        ...
        clickDocument: function(t) {
            var a = t.target;
            $(a).hasClass("ordinary-span-edit") || "block" === $(a).parents(".edit-tip").css("display") || ($(".output-wrap .target-output span").removeClass("ordinary-span-edit"), "block" === $(".edit-tip").css("display") && $(".edit-tip").hide())
        },
        ...
        listItemSelected: function(t) {
            var a, e = t.target,
            i = $(".target-output .ordinary-span-edit");
            return $(e).hasClass("edit-input") ? void $(".edit-input").focus() : (a = $.trim($(e).hasClass("edit-submit") ? $(".edit-input").val() : $(e).text()), this.checkSpanChange({
                target: $(i),
                newText: a
        ...
        execSpanClicked: function(t) {
            ...
            e.hasClass("ordinary-span-edit") || ("-1" !== s && (i[n] = {
                oritext: r
            }), $(a).attr("tabcount", -1).addClass("ordinary-span-edit").focus().siblings("span").removeClass("ordinary-span-edit"), $(a).parents("p").siblings().find("span").removeClass("ordinary-span-edit"), i[n] && i[n].data ? this.showEditTipBox({
                target: a,
                data: i[n].data
        ...
        showEditTipBox: function(t) {
            ...
            if (0 !== n.length) {
                for (var d = 0,
                p = n.length; p > d; ++d) o += '<a href="javascript:void(0);" title="' + n[d] + '">' + n[d] + "</a>";
...
define("translation:widget/translate/output/fanyiModSwitch",
function(e, t) {
    "use strict";
    ...
    n = {
        ...
        bindEvents: function() {
            var e = this;
            $(".output-wrap").on("click", ".op-double-lang",
            function() {
                e.doubleLangClicked({
                    target: this
                })
            }).on("click", ".op-jp-pingyin-btn",
            function() {
                e.switchJapan({
                    target: this
                })
            }).on("click", ".op-lm-pingyin-btn",
            function() {
                e.switchLuoma({
                    target: this
                })
            }).on("click", ".op-zh-pingyin-btn",
            function() {
                e.switchZhong({
                    target: this
                })
        ...
        doubleLangClicked: function(e) {
            ...
            a = $(t).find("span"),
            n = !1;
            a.hasClass("op-check") ? (this.doubleLangNeedChecked(), a.removeClass("op-check").addClass("op-checked"), n = !0, o.set("doubleLangChecked", !0)) : a.hasClass("op-checked") && (this.doubleLangNeedShutdown(), a.removeClass("op-checked").addClass("op-check"), o.set("doubleLangChecked", !1)),
            s.sameHeight()
        },
        ...
        switchJapan: function(e) {
            ...
            n.hasClass("op-checked") ? (t.hide(), o.show(), a.setCookie("JAPAN_PINYIN_SWITCH", 0, {
                expires: 2592e6
            }), n.removeClass("op-checked").addClass("op-check"), _hmt.push(["_trackEvent", "首页", "web端关闭日语假名对照"])) : (t.show(), o.hide(), a.setCookie("JAPAN_PINYIN_SWITCH", 1, {
                expires: 2592e6
            }), n.removeClass("op-check").addClass("op-checked"), _hmt.push(["_trackEvent", "首页", "web端开启日语假名对照"])),
            s.sameHeight()
        },
        switchLuoma: function(e) {
            ...
            o = $(".target-output"),
            n = $(e.target).find("span");
            n.hasClass("op-checked") ? (t.hide(), o.show(), a.setCookie("LUOMA_PINYIN_SWITCH", 0, {
                expires: 2592e6
            }), n.removeClass("op-checked").addClass("op-check"), _hmt.push(["_trackEvent", "首页", "web端关闭韩语罗马音对照"])) : (t.show(), o.hide(), a.setCookie("LUOMA_PINYIN_SWITCH", 1, {
                expires: 2592e6
            }), n.removeClass("op-check").addClass("op-checked"), _hmt.push(["_trackEvent", "首页", "web端开启韩语罗马音对照"])),
            s.sameHeight()
        },
        switchZhong: function(e) {
            ...
            o = $(".target-output"),
            n = $(e.target).find("span");
            n.hasClass("op-checked") ? (t.hide(), o.show(), a.setCookie("CHINA_PINYIN_SWITCH", 0, {
                expires: 2592e6
            }), n.removeClass("op-checked").addClass("op-check"), _hmt.push(["_trackEvent", "首页", "web端关闭中文拼音对照"])) : (t.show(), o.hide(), a.setCookie("CHINA_PINYIN_SWITCH", 1, {
                expires: 2592e6
            }), n.removeClass("op-check").addClass("op-checked"), _hmt.push(["_trackEvent", "首页", "web端开启中文拼音对照"])),
            s.sameHeight()
        }
    };
...
define("translation:widget/translate/output/yellow",
function(t, a) {
    "use strict";
    var e = t("translation:widget/common/environment"),
    ...
    i = {
        bindEvents: function() {
            var t = this;
            $(".output-wrap").on("mouseover", ".target-output > span[space]",
            function() {
                t.onFloatingYellow({
                    target: this
                })
            }).on("mouseout", ".target-output > span[space]",
            function() {
                t.offFloatingYellow({
                    target: this
                })
            }).on("mouseover", ".japan-output-item",
            function() {
                t.onJpItemFloating({
                    target: this
                })
            }).on("mouseout", ".japan-output-item",
            function() {
                t.offJpItemFloating({
                    target: this
                })
            }).on("mouseover", ".luoma-output-item",
            function() {
                t.onLuomaItemFloating({
                    target: this
                })
            }).on("mouseout", ".luoma-output-item",
            function() {
        ...
        onFloatingYellow: function(t) {
            ...
            if (1 === p) {
                ...
                for (var b = 0,
                x = [], y = 0; p > y; y++) x.push(parseInt(l[y].split("|")[0]));
                for (var I = 0; p > I; I++) for (var C = 0; p - I > C; C++) if (x[C] > x[C + 1]) {
                    var F = x[C];
                    x[C] = x[C + 1],
                    x[C + 1] = F;
                    var E = l[C];
                ...
                B = l.length; B > y; y++) {
                    ...
                    m = n.cutByByte(s, 0, c),
                    d = s.substr(m.length + v.length);
                    if (m = this.textEscape(m), v = this.textEscape(v), d = this.textEscape(d), 0 !== y) {
                        var j = u.pop(),
                        ...
                        u.push(d),
                        b = c + f
                    } else u = [m, '<span class="high-light-bg">' + v + "</span>", d],
                    b = c + f
                }
                g = u.join("")
            }
        ...
        offFloatingYellow: function(t) {
            var a = t.target,
            n = $(a);
            if (n.removeClass("high-light-bg"), e.get("doubleLangChecked")) {
                var i = n.parent(),
                o = i.prev(),
                s = o.text();
                o.text(s)
            } else $(".textarea-bg-text").html("")
        },
...
define("translation:widget/translate/output/fanyiClickBtn",
function(t, n) {
    "use strict";
    var e = t("translation:widget/common/environment"),
    o = t("translation:widget/common/soundURIGenerator"),
    ...
    a = {
        bindEvents: function() {
            var t = this;
            $(".output-wrap").on("click", ".op-sound",
            function() {
                t.soundClicked({
                    target: this
                })
            }).on("mouseenter", ".op-sound",
            function() {
                t.soundOver({
                    target: this
                })
...
define("translation:widget/translate/output/fanyi",
function(t, a) {
    "use strict";
    var n = t("translation:widget/common/third_party/template"),
    ...
    var D = {
        ...
        normaltrans: function(t) {
            for (var a = t.data.data,
            p = t.data.jp_pinyin,
            u = t.data.phonetic,
            d = {},
            g = $(".select-to-language .language-selected").attr("data-lang"), c = $(".select-from-language .language-selected").attr("data-lang"), D = e.get("rtl"), h = $.inArray(g, D) >= 0, w = $.inArray(c, D) >= 0, y = $.inArray(g, ["ara", "ru", "el"]) >= 0, C = "", I = a.length, k = [], L = [], H = 0; I > H; H++) {
                var N = a[H].dst;
                L.push(N); {
                    a[H].src
                }
                ...
                for (var _ = 0,
                b = a[H].result.length; b > _; _++) {
                    var S = a[H].result[_][5].toString().split("|"),
                    A = parseInt(S[0], 10),
                    B = parseInt(S[1], 10);
                    a[H].result[_][6] = y ? a[H].result[_][1] : r.cutByByte(N, A, A + B)
                }
            }
            C += L.join("\r\n");
            for (var T = "",
...
define("translation:widget/translate/output/output",
function(t, e) {
    "use strict";
    var a = t("translation:widget/common/environment"),
    ...
    c = {
        ...
        bindEvents: function() {
            var t = this;
            $(".translate-wrap").on("mouseover", ".data-hover-tip",
            function() {
                i.isover({
                    target: this
                })
            }).on("mouseout", ".data-hover-tip",
            function() {
                i.isout()
        ...
        clickDocument: function(t) {
            var e = t.target;
            $(e).hasClass("ordinary-span-edit") || "block" === $(e).parents(".edit-tip").css("display") || ($(".output-wrap .target-output span").removeClass("ordinary-span-edit"), "block" === $(".edit-tip").css("display") && $(".edit-tip").hide())
        },
        outputTextIsCopy: function(t) {
            ...
            } else document.selection && (e = document.selection.createRange().text);
            e && (window.clipboardData ? window.clipboardData.setData("Text", e) : t.originalEvent && t.originalEvent.clipboardData ? (t.originalEvent.clipboardData.setData("text/plain", e), t.preventDefault()) : t.clipboardData && (t.clipboardData.setData("text/plain", e), t.preventDefault()))
        },
        checkResponse: function(t, e) {
            this.result = $.extend(!0, {},
            t || {});
            var a = t.res;
            return a.error ? void(999 === parseInt(a.error, 10) ? (this.clearOutputWrap(), o.normaltrans({
                data: {
                    data: [{
                        dst: a.query,
                        src: a.query,
            ...
            t.query)) : 998 === parseInt(a.error, 10) ? window.location.reload() : 997 === parseInt(a.error, 10) ? alert("浏览器cookie功能被禁，请开启此功能") : this.showTimeout()) : void this.execResponse(t, e)
        },
        showTimeout: function() {
            var t = {
                message: "非常抱歉，翻译结果响应超时，请稍后再试!"
            },
            e = n("tplLongTextPrompt", t);
            $(".output-wrap").html(e)
        },
        execResponse: function(t, e) {
            ...
            r = t.to,
            i = t.query,
            u = t.badCaseByForce; ! e && _hmt.push(["_trackEvent", "首页", "web端总共query数"]),
            a && (this.clearOutputWrap(), a.trans_result && o.normaltrans({
                data: a.trans_result
            }), s.init(a, n, r, i, u))
        },
        clearOutputWrap: function() {
            ...
            i.isout(),
            a.get("needLongtextTip") === !0 ? ($(".output-wrap .output-mod").remove(), a.set("needLongtextTip", !1)) : $(".output-wrap").empty().addClass("output-blank"),
            l.empty()
        }
    };
    $(function() {
...
define("translation:widget/translate/translang/langoften",
function(e, t) {
    "use strict";
    var n = e("translation:widget/common/environment"),
    a = e("translation:widget/common/cookie");
    e("translation:widget/common/third_party/json2");
    var l = {
        setFromOften: function() {
            var e = this,
            t = $(".from-language-list");
            this.setLangOften({
                langOften: "from_lang_often",
                langOftenList: t,
                getLanguageOftenFunc: e.getFromOften
            })
        },
        setToOften: function() {
            var e = this,
            t = $(".to-language-list");
            this.setLangOften({
                langOften: "to_lang_often",
                langOftenList: t,
                getLanguageOftenFunc: e.getToOften
            })
        },
        setLangOften: function(e) {
            var t, n = {
                value: "",
                text: ""
            },
            l = e.langOften,
            g = e.langOftenList,
            f = e.getLanguageOftenFunc,
            o = a.getCookie(l);
            o ? (/%/.test(o) && (o = unescape(o)), t = JSON.parse(o)) : t = [];
            var i = g.find(".data-lang");
            for (i.each(function() {
                var e = $(this);
                if (e.hasClass("lang-selected")) {
                    n = {
                        value: e.attr("value"),
                        text: $.trim(e.text())
                    };
                    for (var a = 0; a < t.length; a++) n.value === t[a].value && t.splice(a, 1);
                    return t.push(n),
                    !1
                }
            }); t.length > 3;) t.shift();
            t.length > 0 && (a.setCookie(l, escape(JSON.stringify(t)), {
                expires: 2592e6
            }), f.call(this))
        },
        setDefault: function(e) {
            ...
            if (!n || !/%/.test(n)) {
                ...
                a.setCookie(t, escape(JSON.stringify(l)), {
                    expires: 2592e6
                })
            }
        },
        getFromOften: function() {
            var e = $(".from-language-list").find(".language-often");
            this.getLangOften({
                langOften: "from_lang_often",
                currlang: $(".select-from-language").find(".language-selected").attr("data-lang"),
                langOftenList: e
            })
        },
        getToOften: function() {
            var e = $(".to-language-list").find(".language-often");
            this.getLangOften({
                langOften: "to_lang_often",
                currlang: $(".select-to-language").find(".language-selected").attr("data-lang"),
                langOftenList: e
            })
        },
        getLangOften: function(e) {
            var t = e.langOftenList,
            l = t.find(".language-often-text"),
            g = e.langOften,
            f = e.currlang;
            if (a.getCookie(g)) {
                var o = a.getCookie(g);
                /%/.test(o) && (o = unescape(o));
                var g = JSON.parse(o);
                t.find(".data-lang").parent("li").remove();
                for (var i = "",
                s = n.get("ocrLangList"), r = 0; r < g.length; r++) {
                    var u = g[r],
                    c = s.includes(u.value);
                ...
                l.length <= 0 && (i += '<li class="language-often-text">-常用语种</li>'),
                t.append(i)
            }
        },
        showOftenBubble: function() {
            a.getCookie("HIDEOFTENLANGBUBBLE") ? $(".often-lang-bubble").hide() : $(".often-lang-bubble").show()
        },
        hideOftenBubble: function() {
            $(".often-lang-bubble").hide(),
            a.setCookie("HIDEOFTENLANGBUBBLE", 1, {
                expires: 2592e7
            })
        },
        bindEvents: function() {
            var e = this;
            $(".from-language-list").on("click", ".often-lang-bubble",
            function() {
                e.hideOftenBubble()
            })
        }
    ...
    t.setFromOften = function() {
        l.setFromOften()
    },
    t.setToOften = function() {
        l.setToOften()
    }
});;
define("translation:widget/translate/translang/manualTrans",
function(a, t, e) {
    "use strict";
    function n() {
        if (0 === r.getVal().length) return void s.removeClass("manual-trans-btn-disable");
    ...
    s.on("click",
    function() {
        $(this).hasClass("manual-trans-btn-disable") || (_hmt.push(["_trackEvent", "首页", "16_首页页面_点击人工翻译按钮"]), l({
            from: $(".select-from-language .language-selected").attr("data-lang"),
            to: $(".select-to-language .language-selected").attr("data-lang"),
            query: r.getVal(),
...
define("translation:widget/translate/translang/tolang",
function(a, t) {
    "use strict";
    var e = a("translation:widget/common/third_party/template"),
    n = a("translation:widget/common/environment"),
    l = a("translation:widget/translate/translang/transbtn"),
    s = a("translation:widget/translate/translang/langoften"),
    g = a("translation:widget/translate/translang/manualTrans"),
    o = {
        toBtnClicked: function() {
            "none" === $(".to-language-list").css("display") && this.reRenderToList(),
            $(".to-language-list").toggle(0,
            function() {
                "block" === $(".to-language-list").css("display") ? $(".select-to-language .arrow-down").addClass("lang-arrow-up") : "none" === $(".to-language-list").css("display") && $(".select-to-language .arrow-down").removeClass("lang-arrow-up")
            })
        },
        reRenderToList: function() {
            var a = n.get("langMap"),
            t = $(".select-from-language .language-selected").attr("data-lang"),
            l = a[t],
            s = $(".select-to-language .language-selected").attr("data-lang");
            $(".to-language-list .data-lang").each(function() {
                var a, t = $(this),
                g = t.attr("value"),
                o = n.get("ocrLangList"),
                r = {
                    ...
                    text: t.text(),
                    isSelected: g === s ? !0 : !1,
                    supportOcr: o.includes(g)
                };
                if (l && l.length > 0 && $.inArray(g, l) < 0) {
                    if (t.hasClass("new-lang-disable")) return;
                    a = e("tplLangItemDisable", r)
                } else {
                    if (!t.hasClass("new-lang-disable")) return;
                    a = e("tplLangItem", r)
                }
        ...
        hideToWrap: function() {
            "block" === $(".to-language-list").css("display") && ($(".to-language-list").hide(), $(".select-to-language .arrow-down").removeClass("lang-arrow-up"))
        },
        tolangChange: function(a) {
            var t = a.lang,
            e = this;
            $(".to-language-list .data-lang").each(function() {
                var n = $(this);
                return n.attr("value") === t ? (e.tolangItemSelect({
                    target: n,
                    trans: a.trans
                }), !1) : void 0
            })
        },
        tolangItemSelect: function(a) {
            var t = a.target,
            e = t.attr("value"),
            n = t.text();
            $(".select-to-language .language-selected").attr("data-lang", e).text(n),
            $(".to-language-list .lang-selected").removeClass("lang-selected"),
            t.addClass("lang-selected"),
            this.hideToWrap(),
            a.trans && l.doTrans(),
            s.setToOften(),
            g.updateManualTransBtn()
        }
    };
    t.toBtnClicked = function() {
        o.toBtnClicked()
    },
    t.tolangChange = function(a) {
        o.tolangChange(a)
    },
    t.tolangItemSelect = function(a) {
        o.tolangItemSelect(a)
    },
    t.hideToWrap = function(a) {
        o.hideToWrap(a)
    }
});;
define("translation:widget/translate/translang/exchange",
function(a, n) {
    "use strict";
    var t, e = a("translation:widget/common/environment"),
    g = a("translation:widget/translate/translang/fromlang"),
    ...
    s = {
        ...
        animateExchange: function() {
            ...
            1 === parseInt(e.attr("aflag"), 10) ? (a( - 2, -202, 8, 200), e.attr("aflag", 0)) : (a( - 202, -2, 8, 200), e.attr("aflag", 1))
        },
...
define("translation:widget/translate/input/processlang",
function(t, n, e) {
    "use strict";
    function a(t, n, e) {
        return g.set("detectLang", t),
        g.get("fromLangIsAuto") ? (n = t, e = $(".select-to-language .language-selected").attr("data-lang")) : t !== e || g.get("langChangedByUser") || ("zh" === e && $.inArray(n, o) >= 0 ? (s.execExchange(!0), e = n, n = t, $(".trans-prompt").hide()) : "zh" === n && $.inArray(e, o) >= 0 && (s.execExchange(!0), e = n, n = t, $(".trans-prompt").hide())),
    ...
    function r(t, n, e) {
        return l.includes(n) && l.includes(e) && t === e ? (s.execExchange(!0), e = n, n = t, $(".trans-prompt").hide()) : c.includes(n) && "en" === e || !g.get("langList").hasOwnProperty(t) || i.renderPrompt(t, !0),
        {
            fromLang: n,
            toLang: e
        }
    }
    var g = (t("translation:widget/translate/input/textarea"), t("translation:widget/common/environment")),
    s = t("translation:widget/translate/translang/exchange"),
    i = t("translation:widget/translate/input/prompt"),
    o = ["ara", "de", "en", "spa", "it", "fra", "pt", "ru", "th", "kor"],
    l = (g.get("langList"), ["zh", "en", "jp", "kor"]),
    c = ["de", "spa", "it", "fra", "pt"];
    e.exports = {
        getLang: a,
        processOcrLang: r
...
define("translation:widget/translate/input/soundicon",
function(n, t) {
    "use strict";
    ...
    s = {
        ...
        show: function() {
            ...
            return ! o.isLangSound(n) || s > t ? (this.showDisableSoundIcon(), void this.hideSoundBtn()) : void this.showSoundBtn()
        },
...
define("translation:widget/translate/input/hash",
function(a, t) {
    "use strict";
...
define("translation:widget/translate/input/longtext",
function(t, n) {
    "use strict";
    ...
    p = {
        showTip: function(t) {
            var n, p = t.query,
            o = "百度翻译字数限制为" + i.MAX_QUERY_COUNT + '字, "',
            e = '"及其后面没有被翻译!';
...
define("translation:widget/translate/input/translate",
function(t, a) {
    "use strict";
    ...
    w = {
        onTrans: function(t) {
            ...
            e = this,
            s = t && t.transtype;
            if (r.isUrl(a)) return void this.translateWebPage(a);
        ...
        translateSuccess: function(t, a, e, r, o) {
            return n.getVal() ? (r && f.add(a, e, $.trim(r)), f.hideHistory(), h.hide(), s.checkResponse({
                res: t,
                from: a,
                to: e,
                query: r,
...
define("translation:widget/translate/input/sound",
function(t, e) {
    "use strict";
    var i = {
        timer: null,
...
function(t, r) {
    ...
    l.dealUrlQuery = function() {
        ...
        $(".ordinary-wrap").length > 0 ? $(".ordinary-wrap").html(this.tpl) : ($(".output-wrap").html(this.tpl), $(".url-tip").css({
            margin: "10px"
        }))
    },
...
define("translation:widget/translate/input/rttrans",
function(t, e) {
    "use strict";
    ...
    s = (t("translation:widget/common/cookie"), t("translation:widget/translate/input/translate")),
    o = (t("translation:widget/translate/input/urlQueryHandler"), {
        ...
        onRtTrans: function(t, e) {
            ...
            s = this;
            if (!i || !a) return void(this.timer && clearTimeout(this.timer));
        ...
        doTrans: function(t) {
            var e = r.getVal();
            if (e && !i.isUrl(e)) {
                if ($(".output-wrap").children().length <= 0 || "paste" === t) s.onTranslate({
                    transtype: "realtime"
                });
                else if (e !== this.prevQuery) {
                    if (a.getByte(e) > 500 && a.getByte(this.prevQuery) > 500) return;
                    s.onTranslate({
                        transtype: "realtime"
                    })
                }
...
define("translation:widget/translate/input/inputSoungUrlHandler",
function(t, n) {
    "use strict";
...
function(t, e) {
    ...
    function u(t) {
        ...
        if (13 === t.which) {
            ...
            if (l.length > 0) return t.preventDefault(),
            t.stopPropagation(),
            l.trigger("click"),
            void(v = !0);
            if ("none" !== m.css("display")) return y = !0,
            t.preventDefault(),
            t.stopPropagation(),
            void n()
        }
    ...
    function c(t) {
        t = t.replace(/(^\s*)|(\s*$)/g, "");
        for (var e = /^[a-zA-Z]+([\-'][a-zA-Z]+)*$/,
        n = t.split(/\s+/), a = 0, s = n.length; s > a; a++) if (!e.test(n[a])) return ! 1;
        return ! 0
    }
    var d, f = t("translation:widget/common/third_party/template"),
    h = t("translation:widget/translate/input/translate"),
    p = $("#baidu_translate_input"),
    m = $("#sug-wrap"),
    v = !1,
    y = !1,
    w = {
...
define("translation:widget/translate/input/clear",
function(t, n) {
    "use strict";
    ...
    r = t("translation:widget/translate/input/prompt"),
    s = t("translation:widget/translate/output/output"),
...
define("translation:widget/translate/input/fontSize",
function(t, e) {
    "use strict";
    function s(t, e) {
        var s = t[0],
...
define("translation:widget/translate/zonedword/selection",
function(e, t) {
    "use strict";
    var n = (e("translation:widget/common/string"), {
        ...
        clearSelectionZone: function(e) {
            if ("undefined" != typeof e.target.setSelectionRange) e.target.setSelectionRange(0, 0);
            else if ("undefined" != typeof window.getSelection && window.getSelection().rangeCount > 0) window.getSelection().collapseToStart();
...
define("translation:widget/translate/zonedword/loading",
function(n, o) {
    "use strict";
...
define("translation:widget/translate/zonedword/dict",
function(t, e) {
    "use strict";
    var o = t("translation:widget/common/third_party/template"),
    ...
    n = {
        render: function(t) {
            ...
            var w, l, s = $(window).scrollTop(),
            p = $(window).height(),
            c = $("#zonedword-wrap").outerHeight();
            d - 30 > p - c ? (l = d + s - 60 - c, w = l > 0 ? l: d + s) : w = d + s,
            $("#zonedword-wrap").css({
                top: w,
                left: a
            }).show()
...
define("translation:widget/translate/zonedword/fanyi",
function(t, r) {
    "use strict";
    ...
    e = {
        render: function(t) {
            ...
            var p, g, c = $(window).scrollTop(),
            f = $(window).height(),
            h = $("#zonedword-wrap").outerHeight();
            e - 30 > f - h ? (g = e + c - 60 - h, p = g > 0 ? g: e + c) : p = e + c,
            $("#zonedword-wrap").css({
                top: p,
                left: d
            }).show()
...
define("translation:widget/translate/zonedword/zonedFavo",
function(t, n, o) {
    "use strict";
    var e = t("translation:widget/common/environment"),
...
define("translation:widget/translate/zonedword/wordWrap",
function(t, e) {
    "use strict";
    ...
    g = {
        ...
        showWrap: function(t) {
            ...
            r = n.getText(t),
            a = this;
            e && this.mouseClickFlag && (this.setMousePosition(t), l && clearTimeout(l), l = setTimeout(function() {
                var e = d.get("dbClickHighlightZone");
                if (void 0 !== e && "" !== e.query ? (r = e.query, d.set("zonewordQueryFrom", e.area), d.remove("dbClickHighlightZone"), n.clearSelectionZone(t)) : d.remove("zonewordQueryFrom"), !(r.length <= 0)) {
                    var i = {
        ...
        transResultIsReturn: function(t, e, o, n) {
            if (!t || !t.error) {
                ...
                t && t.type && (1 === t.type ? (a.render({
                    ...
                    from: e,
                    to: o
                })), _hmt.push(["_trackEvent", "首页", "划词翻译结果框出现次数"]), "keywords" === d.get("zonewordQueryFrom") && _hmt.push(["_trackEvent", "首页", "Web重点词汇卡片highlight出划词翻译框次数"]))
            }
        },
        rightClickHideWrap: function(t) {
            ...
            t && 2 !== t.button && 3 !== t.button && (this.mouseClickFlag = !0, n.clearSelectionZone(t))
        },
...
define("translation:widget/translate/input/drag",
function(t, n, o) {
    "use strict";
    function r() {
        d.dragCompatibility && ($("body").dndhover().on("dndHoverStart",
        function() {
            a("drag")
        }).on("dragover",
        function(t) {
...
function(t, a, n) {
    "use strict";
    function e() {
        if (h.get("isInRtTransState") === !0) return void h.set("isInRtTransState", !1);
        var t = s.get(),
    ...
    function r(a) {
        ...
        l = void 0;
        l = a ? o.val() : n.query,
        l.length > 0 ? (l = l.replace(/\\r\\n/gi, "\n"), l = g.decodeHTML(l), /firefox/i.test(navigator.userAgent) === !0 && (l = l.replace(/%0A/gi, "\r\n"), l = unescape(l)), a || o.val(l), v.switchFontSize(), u.hasQuery(l), t("translation:widget/translate/input/dataTransfer").clearInputImage()) : (y && (i(), y = !1), p.clearInputAndOutput()),
        u.focus();
        var h = !1;
        e && c.fromlangChange({
            lang: e,
    ...
    function o() {
        ...
        s && g ? (a.hasOwnProperty("length") && 0 === a.length && i(), l({
            from: s,
            to: g,
            query: a
        })) : (y = !0, r())
    ...
    function i() {
        window.hasStatUploadBtnShow || (_hmt.push(["_trackEvent", "首页", "74_首页页面_上传文档按钮展示"]), window.hasStatUploadBtnShow = !0)
    }
...
define("translation:widget/translate/input/events",
function(t, n) {
    "use strict";
    function e(t) {
        return function() {
    ...
    function o(t) {
        t.stopPropagation(),
        (!S.pasteCompatibility || S.handle(t)) && (d.onRtTrans(t, "paste"), y.switchFontSize())
    }
    function r(t) {
        k.onTextAreaKeyDown(t)
    }
    function i(t) {
        var n = $("#baidu_translate_input").val(),
        e = f[0];
        if (! ("input" !== t.type && ("oninput" in e && (!I || "keyup" !== t.type || 8 !== t.which && 46 !== t.which) || "keyup" !== t.type || 38 === t.which || 40 === t.which || k.getCloseSugByEnter() || 13 === t.which && k.getTranslatedByKeyDown()))) {
            var a = y.switchFontSize();
            a || t.triggerByOcr ? k.clearAndHideSug() : T.getByte(n) <= 24 && k.loadSug()
        }
        if (C.hideWrap(), w.onHistoryInput(), _.onAdLinkInput(), n) {
            if (13 === t.which) return k.getCloseSugByEnter() && k.setCloseSugByEnter(!1),
            void(k.getTranslatedByKeyDown() ? k.setTranslatedByKeyDown(!1) : g.onTranslate({
                transtype: "enter"
            }));
            s.hasQuery(n),
            x.get("shouldClearPromptOnInput") && (p.hide(), x.set("shouldClearPromptOnInput", !1))
        } else v.translateStopRepeat() || v.shutdownAudio(),
        m.clearAll(!1)
    }
    var s = t("translation:widget/translate/input/textarea"),
    l = t("translation:widget/translate/input/soundicon"),
    c = t("translation:widget/translate/input/sound"),
    u = t("translation:widget/translate/input/correct"),
    d = t("translation:widget/translate/input/rttrans"),
    p = t("translation:widget/translate/input/prompt"),
    g = t("translation:widget/translate/input/translate"),
    h = t("translation:widget/translate/input/inputSoungUrlHandler"),
    m = t("translation:widget/translate/input/clear"),
    w = t("translation:widget/translate/history/history"),
    f = s.getElem(),
    v = t("translation:widget/translate/details/dictionary/simplemeans"),
    y = t("translation:widget/translate/input/fontSize"),
    k = t("translation:widget/translate/input/inputSug"),
    T = t("translation:widget/common/string"),
    C = t("translation:widget/translate/zonedword/wordWrap"),
    _ = t("translation:widget/translate/details/adLink/adLink"),
    S = t("translation:widget/translate/input/dataTransfer"),
    b = t("translation:widget/translate/input/drag"),
    E = t("translation:widget/translate/translang/manualTrans"),
    x = t("translation:widget/common/environment"),
    D = t("translation:widget/translate/input/uploader"),
    B = t("translation:widget/translate/docTranslate/docTransUtil"),
    R = t("translation:widget/login/login"),
    I = "oninput" in f[0] && "documentMode" in document && 9 === document.documentMode;
    n.onClearBtnClick = function() {
        return $("#main-outer").hasClass("doc-trans-mode") ? (window._hmt.push(["_trackEvent", "首页", "文档翻译_上传后点x删除文档"]), void(location.href = "/")) : (v.translateStopRepeat() || v.shutdownAudio(), m.clearAll(), y.switchFontSize(), k.clearAndHideSug(), void E.updateManualTransBtn())
    },
    n.init = function() {
        function n(t) {
            var n = S.pasteCompatibility || S.dragCompatibility;
            B.logWrongFileFormat(t),
            alert("目前仅支持 " + (window.common.pdfHit ? "pdf、": "") + "docx、doc、ppt、pptx、xls、xlsx" + (n ? "、jpg、png、bmp、jpeg ": " ") + "格式哦")
        }
        var i = this,
        d = this;
        f.on("input", a).on("keyup", a).on("paste", o).on("keydown", r),
        $(document).on("paste",
        function(t) {
            S.pasteCompatibility && S.handle(t)
        }),
        m.getElem().on("click",
        function(t) {
            t.preventDefault(),
        ...
        function(t) {
            ...
            var n = h.getInputSoundUrl();
            c.makeSound(this, n),
            _hmt.push(["_trackEvent", "首页", "web端原文发音TTS"]),
            _hmt.push(["_trackEvent", "首页", "web端点击发音按钮"])
        }),
        l.getElem().on("mouseover",
        function() {
            if ("hover" === x.get("soundTriggerMode")) {
                var t = $(this);
        ...
        l.getElem().on("mouseout",
        function() {
            d.timer && clearTimeout(d.timer)
        }),
        $(".trans-correct").on("click", ".correct-query",
        function(t) {
            t.preventDefault();
            var n = $(this).text();
            u.onCorrect(n),
        ...
        $(".trans-prompt").on("click", ".source-lang",
        function(t) {
            t.preventDefault();
            var n = $(this).attr("data-lang");
            p.onPrompt(n),
            _hmt.push(["_trackEvent", "首页", "web端点击语种检测提示"])
        }).on("click", ".open-from-lang",
        function(n) {
            n.stopPropagation();
            var e = t("translation:widget/translate/translang/fromlang");
            e.fromBtnClicked()
        }),
        $(".trans-input-wrap").on("click", ".input-wrap",
        function(t) {
            var n = $(t.target); (n.hasClass("input-wrap") || n.hasClass("textarea-wrap")) && (t.preventDefault(), s.focus())
        }),
        b.bindEvent();
        var g = $("#image-holder"),
        w = $("#preview-img"),
        ...
        function() {
            if (w.is(":hidden")) {
                ...
                t.onload = function() {
                    ...
                    1e3),
                    y.addClass("is-zoom-in");
                    try {
                        $(window).trigger("resize")
                    } catch(e) {}
                },
                t.src = n.createObjectURL(g.data("file")),
                _hmt.push(["_trackEvent", "首页", "56_首页页面_点击放大缩略图的次数"])
            } else {
                y.removeClass("is-zoom-in");
                try {
                    $(window).trigger("resize")
                } catch(e) {}
            }
        ...
        function(n) {
            ...
            if ("/docTransMode" === e) B.currTask.file ? ($(".doc-trans-file").text(B.currTask.file.name), B.clearDocTransViewMode(), $("#main-outer").addClass("doc-trans-mode"), localStorage.getItem("docTransLangGuideFlag") || ($(".doc-trans-operation").addClass("guiding"), $(".doc-trans-operation .doc-trans-dir").addClass("open"))) : B.clearDocTrans();
            else if (B.viewModeRegExp.test(e)) {
                var a = t("translation:widget/translate/docTranslate/docTranslate");
                a.onHashChange()
            } else B.clearDocTrans(),
        ...
        function() {
            var t = e(regeneratorRuntime.mark(function a(t) {
                ...
                return regeneratorRuntime.wrap(function(a) {
                    ...
                    case 0:
                        if (!B.isSupportByDocTrans(t.type)) {
                            a.next = 15;
                            break
                        }
                        return a.next = 3,
                        R.ensureUserLoginAsync();
                    case 3:
                        if (e = 10, !(t.size > 1024 * e * 1024)) {
                            a.next = 9;
                            break
                        }
                        return D.removeFile(t, !0),
                    ...
                    case 9:
                        m.clearAll(),
                        B.currTask.file = t,
                        B.currTask.fileName = t.name,
                        location.hash = "/docTransMode",
                        a.next = 17;
                        break;
                    case 15:
                        t.type.startsWith("image/") && (S.pasteCompatibility || S.dragCompatibility) ? S.processImgFile(t.getSource().source) : n(t),
                        D.removeFile(t, !0);
                    case 17:
                    case "end":
                        return a.stop()
        ...
        $("#upload-btn").on("click",
        function() {
            Boolean(x.get("account").is_login) ? $("#upload-btn-hidden").find('input[type="file"]').click() : R.newLoginInstanceAsync(),
            _hmt.push(["_trackEvent", "首页", "75_首页页面_点击上传文档按钮"])
        });
        var k = localStorage.getItem("hasShowDocTip");
        k || ($("#upload-btn").addClass("with-first-tip"), $(window).on("click.hideDocTip",
        function() {
            $("#upload-btn").removeClass("with-first-tip"),
            $(window).off("click.hideDocTip"),
            localStorage.setItem("hasShowDocTip", "true")
        })),
        $(window).on("click.stopSound",
        function(t) {
            var n = $(t.target);
            n.hasClass("icon-sound") || n.hasClass("op-sound") || n.hasClass("sound-btn") || n.hasClass("icon-repeat") || n.hasClass("op-repeat") || (BTPM.doPause(), v.shutdownRepeat(), $(".op-sound").removeClass("op-sound-active"))
        });
        var T = [32, 13];
        $(document).on("keypress",
        function(t) {
            if (!f.is(":focus") && !(f.val().trim().length > 0 || T.includes(t.which) || t.altKey || t.ctrlKey || t.metaKey)) {
                var n = $("#main-outer");
                if (!n.hasClass("doc-trans-mode") && !n.hasClass("doc-trans-view-mode")) {
                    var e = document.getElementById("passport-login-pop");
                    e && "none" !== e.style.display || f.focus()
                }
            }
        })
    };
...
define("translation:widget/translate/input/dataTransfer",
function(t, e, n) {
    "use strict";
    function r(t) {
        return function() {
    ...
    function a(t) {
        var e = t.type,
        n = null;
        if ("paste" === e) n = t.originalEvent.clipboardData;
        else {
            if ("drop" !== e) return ! 0;
        ...
        if (r) {
            ...
            for (var l = r.length - 1; l >= 0; l--) {
                ...
                if ("file" === p) {
                    ...
                    } else if (y.isSupportByDocTrans(m) && window.common.docHit) {
                        if (f) {
                            s = !0,
                            u = f;
                            break
                        }
                    } else if ("drop" === e && window.common.docHit && !y.isUrlFileInEdge(f)) {
                        y.logWrongFileFormat(f),
                        alert("目前仅支持 " + (window.common.pdfHit ? "pdf、": "") + "docx、doc、ppt、pptx、xls、xlsx、jpg、png、bmp、jpeg 格式哦");
                        break
                    }
                }
            }
        } else for (var g = a.length - 1; g >= 0; g--) {
            var v = a.item(g);
            ...
            if (y.isSupportByDocTrans(v.type) && window.common.docHit) {
                s = !0,
                u = v;
                break
            }
            if ("drop" === e && window.common.docHit && !y.isUrlFileInEdge(v)) {
                y.logWrongFileFormat(v),
                alert("目前仅支持 " + (window.common.pdfHit ? "pdf、": "") + "docx、doc、ppt、pptx、xls、xlsx、jpg、png、bmp、jpeg 格式哦");
                break
            }
        }
        if (i) {
            if (t.preventDefault(), _hmt.push("drop" === e ? ["_trackEvent", "首页", "53_首页页面_上传图片方式_拖拽"] : ["_trackEvent", "首页", "53_首页页面_上传图片方式_复制"]), !c()) return h(o, !1),
            !1
        } else if (s) return t.preventDefault(),
    ...
    function s(t, e, n) {
        return new Promise(function(r, a) {
            ...
            function(t) {
                if (200 !== t.target.status) _hmt.push(["_trackEvent", "首页", "57_首页页面_浏览器弹窗提示_网络问题 请稍候重试"]),
                a("网络问题，请稍后重试");
                else {
    ...
    function u(t) {
        return new Promise(function(e, n) {
            if (t.size > O) return _hmt.push(["_trackEvent", "首页", "57_首页页面_浏览器弹窗提示_图片大小超过10M"]),
            ...
            if (!r) return _hmt.push(["_trackEvent", "首页", "57_首页页面_浏览器弹窗提示_上传文件暂不支持图片翻译"]),
            ...
            s.onload = function() {
                ...
                return t.width = a,
                t.height = i,
                l(a) && l(i) ? void e(!0) : (_hmt.push(["_trackEvent", "首页", "57_首页页面_浏览器弹窗提示_上传的图片不符合要求"]), void n("您上传的图片不符合要求，短边至少15px，长边最长4096px"))
            },
            s.onerror = function() {
                n("图片文件损坏，无法解析")
            },
    ...
    function c() {
        ...
        t && (_hmt.push(["_trackEvent", "首页", "57_首页页面_浏览器弹窗提示_您的操作过于频繁 请稍候再试"]), alert("上传图片过于频繁，请稍后再试")),
        t
    }
    function l(t) {
        return t >= 15 && 4096 >= t
    ...
    function d(t) {
        return D.includes(t) || "auto" === t ? !0 : (alert("当前语言不支持图片识别，请选择语言"), v.fromBtnClicked(), !1)
    }
    function p(e, n) {
        if (j.removeClass("with-loading-ocr-tip"), 0 !== e.errno || 0 === e.errno && 0 === e.data.src.length) {
            t("translation:widget/translate/input/clear").show(),
            k.set("shouldClearPromptOnInput", !0);
            var r = t("translation:widget/translate/input/prompt");
            "auto" === n ? (r.showCustomPrompt("未识别出图片文字，请  ", "选择语言重试", "open-from-lang"), _hmt.push(["_trackEvent", "首页", "55_首页页面_输入框内提示_图片识别失败，请选择语言"])) : (r.showCustomPrompt("图片识别失败，请重试"), _hmt.push(["_trackEvent", "首页", "55_首页页面_输入框内提示_图片识别失败，请重试"]))
        } else {
            var a = e.data.src.join(""),
            i = e.data.from,
            o = w.getElem();
            o.val(a),
            k.set("isProcessOcrResult", !0);
    ...
    function f() {
        return $(".trans-input-wrap").hasClass("with-image") && $("#image-holder").data("file") && !$("#baidu_translate_input").val() ? (h($("#image-holder").data("file"), !0), !1) : !0
    }
    function g(t) {
    ...
    var h = function() {
        var e = r(regeneratorRuntime.mark(function n(e, r) {
            ...
            return regeneratorRuntime.wrap(function(n) {
                for (;;) switch (n.prev = n.next) {
                case 0:
                    if (g(!0), "" === $("#baidu_translate_input").val() && r || (a = t("translation:widget/translate/input/events"), a.onClearBtnClick()), c = $(".select-from-language .language-selected").attr("data-lang"), l = $(".select-to-language .language-selected").attr("data-lang"), d(c)) {
                        n.next = 7;
                        break
                    }
                    return g(!1),
    ...
    v = t("translation:widget/translate/translang/fromlang"),
    w = t("translation:widget/translate/input/textarea"),
    k = t("translation:widget/common/environment"),
    x = t("translation:widget/common/third_party/image-compressor"),
    b = t("translation:widget/common/third_party/bowser"),
    E = t("translation:widget/translate/input/uploader"),
    y = t("translation:widget/translate/docTranslate/docTransUtil"),
    L = new x,
    j = $(".trans-input-wrap"),
    R = $("#image-holder"),
    C = !1,
    ...
    function() {
        if ("1" === window.common.ocrHit) {
            ...
            t && "function" == typeof t.createObjectURL && !b.msie && !b.ucbrowser && window.FormData && "undefined" != typeof window.FileReader && ("draggable" in document.createElement("span") && (I = !0), b.check({
                firefox: "41",
                chrome: "13",
                opera: "12.1"
            },
...
define("translation:widget/translate/translang/transbtn",
function(n, t) {
    "use strict";
...
define("translation:widget/translate/input/dir",
function(t, r) {
    "use strict";
    var a = t("translation:widget/common/environment");
    r.changeDir = function(t) {
        t && ($.inArray(t, a.get("rtl")) >= 0 ? ($(".input-wrap").attr("dir", "rtl"), $(".textarea-clear-btn").css({
            "float": "left",
            margin: "0 10px 0 0"
        })) : ($(".input-wrap").attr("dir", "ltr"), $(".textarea-clear-btn").css({
            "float": "right",
            margin: "0 0 0 10px"
        })))
    }
});;
define("translation:widget/translate/translang/fromlang",
function(a, e) {
    "use strict";
    var t = a("translation:widget/common/environment"),
    n = a("translation:widget/translate/translang/transbtn"),
    l = a("translation:widget/translate/input/dir"),
    s = a("translation:widget/translate/translang/tolang"),
    r = a("translation:widget/translate/translang/langoften"),
    o = a("translation:widget/translate/translang/manualTrans"),
    g = {
        fromBtnClicked: function() {
            $(".from-language-list").toggle(0,
            function() {
                "block" === $(".from-language-list").css("display") ? $(".select-from-language .arrow-down").addClass("lang-arrow-up") : "none" === $(".from-language-list").css("display") && $(".select-from-language .arrow-down").removeClass("lang-arrow-up")
            })
        },
        hideFromWrap: function() {
            "block" === $(".from-language-list").css("display") && ($(".from-language-list").hide(), $(".select-from-language .arrow-down").removeClass("lang-arrow-up"))
        },
        fromlangChange: function(a) {
            var e = a.lang,
            t = this;
            $(".from-language-list a").each(function() {
                var n = $(this);
                return n.attr("value") === e ? (t.fromlangItemSelect({
                    target: n,
                    trans: a.trans,
        ...
        fromlangItemSelect: function(e) {
            var t = e.target,
            g = t.attr("value"),
            i = t.text();
            e.isDetected && (i = "检测到<span>" + i + "</span>"),
            $(".select-from-language .language-selected").attr("data-lang", g).html(i),
            "auto" === g ? this.autoItemSelected({
                isDetected: e.isDetected
            }) : this.normalItemSelected({
                isDetected: e.isDetected
            }),
            l.changeDir(g),
            $(".from-language-list .lang-selected").removeClass("lang-selected"),
            t.addClass("lang-selected"),
            this.hideFromWrap();
            ...
            r.setFromOften(),
            o.updateManualTransBtn()
        },
        autoItemSelected: function(a) {
            a.isDetected || t.set("fromLangIsAuto", !0),
            $(".from-to-exchange .exchange-mask").css({
                "background-position": "-2px 50%"
            });
            var e = $(".from-to-exchange");
            e.hasClass("language-btn") && e.removeClass("language-btn").addClass("language-btn-disable"),
            e.attr("aflag", 0)
        },
        normalItemSelected: function(a) {
            a.isDetected || t.set("fromLangIsAuto", !1);
            var e = $(".from-to-exchange");
            e.hasClass("language-btn-disable") && e.removeClass("language-btn-disable").addClass("language-btn")
        }
    };
    e.fromBtnClicked = function() {
        g.fromBtnClicked()
    },
    e.hideFromWrap = function() {
        g.hideFromWrap()
    },
    e.fromlangChange = function(a) {
        g.fromlangChange(a)
    },
    e.fromlangItemSelect = function(a) {
        g.fromlangItemSelect(a)
    }
});;
define("translation:widget/translate/input/prompt",
function(t, n) {
    "use strict";
    var r = t("translation:widget/common/environment"),
    o = t("translation:widget/translate/translang/fromlang"),
    a = t("translation:widget/common/third_party/template"),
    s = t("translation:widget/translate/history/history"),
    i = t("translation:widget/translate/details/adLink/adLink"),
    p = {
        hidePrompt: function() {
            $(".trans-prompt").hide()
        },
        showPrompt: function(t, n) {
            var a = r.get("langList"),
            s = a.hasOwnProperty(t);
            return r.get("fromLangIsAuto") && s ? (o.fromlangChange({
                lang: t,
                isDetected: !0
            }), void this.hidePrompt()) : void($(".trans-correct").is(":hidden") && (n === t || !s || "wyw" === n && "zh" === t ? this.hidePrompt() : this.renderPrompt(t, !1)))
        },
        renderPrompt: function(t, n) {
            var o = r.get("langList")[t],
            s = a("tplLangPrompt", {
                lang: t,
                langText: o,
                isOcr: n
            });
            $(".trans-prompt .prompt-wrap").html(s).parent().show(),
    ...
    n.show = function() {
        p.showPrompt.apply(p, arguments)
    },
    n.onPrompt = function(t) {
        p.onPrompt(t)
    },
    n.renderPrompt = function() {
        p.renderPrompt.apply(p, arguments)
    },
    n.showCustomPrompt = function() {
        p.showCustomPrompt.apply(p, arguments)
    }
});;
define("translation:widget/translate/input/correct",
function(t, r) {
    "use strict";
    var e, n = t("translation:widget/common/environment"),
    c = t("translation:widget/common/util"),
    o = (t("translation:widget/translate/input/prompt"), t("translation:widget/translate/input/translate")),
    i = "http://correctxt.baidu.com/correctxt?callback=?";
    ...
    var s = {
        ...
        setLastInput: function(t) {
            var r = this;
            return ! this.isEnglishQuery(t) || t.length > 20 ? void $(".trans-correct").hide() : (clearTimeout(e), void(e = setTimeout(function() {
                var e = n.get("lastquery");
                t !== e && (n.set("lastquery", t), r.ajaxCorrect(t))
            },
            300)))
        },
        getCorrect: function(t) {
            if (this.setLastInput(t), !this.isQueryInCheck()) {
                if (!this.isEnglishQuery(t) || t.length > 20) return void $(".trans-correct").hide();
                var r = n.get("lastquery");
                t !== r && (this.setQueryIsInCheck(t), n.set("lastquery", t), this.ajaxCorrect(t))
            }
        },
...
function(t, e) {
    ...
    $.fn.selectRange = function(t, e) {
        return void 0 === e && (e = t),
        this.each(function() {
            if ("selectionStart" in this) this.selectionStart = t,
            this.selectionEnd = e;
            else if (this.setSelectionRange) this.setSelectionRange(t, e);
    ...
    var h = {
        ...
        bindEvent: function() {
            ...
            $(".textarea-wrap .textarea-bg .prompt-text").on("click",
            function() {
                n.focus()
            }),
            $(window).on("resize.textarea",
            function() {
                a.sameHeight()
            })
        },
        ...
        resize: function() {
            ...
            $("#baidu_translate_input")[0].scrollHeight && parseInt($("#baidu_translate_input")[0].scrollHeight, 10) >= t && (i.height($("#baidu_translate_input")[0].scrollHeight), e.height(i.height())),
            a.sameHeight()
        },
...
define("translation:widget/translate/history/storage",
function(r, t) {
    "use strict";
    function n() {
    ...
    t.isSupport = function() {
        try {
            return window.localStorage ? (window.localStorage.isSupport = "true", !0) : !1
        } catch(r) {
            return ! 1
        }
    } (),
    t.setHistory = function(r, t, o, i) {
        for (var l = n() || [], u = l.length, s = 0; u > s; s++) r === l[s][0] && (l.splice(s, 1), u--);
        var c = [r, t, o, i];
        l.push(c),
        u >= a && l.shift(0),
        e(l)
    ...
    t.deleteFromStorge = function(r) {
        ...
        if (t) {
            var a, i;
            for (a = 0, i = t.length; i > a; a++) if (r === t[a][0]) {
                t.splice(a, 1);
                break
            }
            e(t);
...
define("translation:widget/translate/history/history",
function(t, i) {
    "use strict";
    var e = t("translation:widget/common/third_party/template"),
    ...
    l = {
        ...
        bindEvent: function() {
            ...
            }).on("click", ".history-edit-btn",
            function(t) {
                t.preventDefault(),
                t.stopPropagation(),
                s.addClass("history-editing")
            }).on("click", ".history-complete",
            function(t) {
                t.preventDefault(),
                t.stopPropagation(),
                s.removeClass("history-editing")
            }).on("click", ".history-item",
            function(i) {
                i.preventDefault(),
                i.stopPropagation();
                var e = $(this);
        ...
        showHistory: function() {
            if (!n.get("isInHistoryMode")) return void s.hide();
            var t = r.getHistory();
            this.renderHistory({
                data: t,
        ...
        renderHistory: function(t) {
            var i = t.data;
            if (t.forceQuitEditingPattern && s.removeClass("history-editing"), i && i.data.length) {
                for (var n = i.data,
                o = i.len,
                r = [], a = o - 1; a >= 0; a--) {
                    var d = n[a];
...
define("translation:widget/translate/input/indexlog",
function(n) {
    "use strict";
    ...
    a = {
        ...
        bannerIndexDisplayLog: function() {
            var n = t.get();
            if (!n || n && !n.query) {
                if ($(".spread-slide a").length <= 0) return;
...
define("translation:widget/translate/input/input",
function(t) {
    "use strict";
...
define("translation:widget/translate/output/favor",
function(t, e) {
    "use strict";
    var a = t("translation:widget/common/environment"),
    r = t("translation:widget/translate/output/mouseover"),
    ...
    n = {
        ...
        favorIsSaved: function(t) {
            ...
            a = t.target,
            o = t.firstScreen || !1;
            o || ($(a).attr("data-hover-tip-text", "已收藏"), r.isover({
                target: a
            })),
            $(a).attr({
                "favo-id": e,
        ...
        execAdd: function(t) {
            ...
            o.hasClass("op-favo-cur") ? (this.deleteFavor({
                id: o.attr("favo-id"),
                target: a
            }), _hmt.push(["_trackEvent", "首页", "web端总取消收藏"]), o.attr("data-hover-tip-text", "已取消收藏"), r.isover({
                target: a
            }), setTimeout(function() {
                r.isout(),
                o.attr("data-hover-tip-text", "收藏结果")
            },
            2e3)) : ("zonedword" === n ? _hmt.push(["_trackEvent", "首页", "web端划词翻译添加收藏"]) : o.parents(".dictionary-wrap").length > 0 ? (e = 1, _hmt.push(["_trackEvent", "首页", "web端词典结果添加收藏"])) : (e = 0, _hmt.push(["_trackEvent", "首页", "web端译文框添加收藏"])), this.realAdd({
                target: a,
                from: n,
                category: e
            }))
        ...
        realAdd: function(t) {
            ...
            i = "",
            d = t.category,
            c = $.trim($("#baidu_translate_input").val().replace(/<br( \/)?>/gi, "&lt;br$1&gt;")),
            l = $(".select-from-language .language-selected").attr("data-lang") + "2" + $(".select-to-language .language-selected").attr("data-lang");
            "zonedword" === n ? (i = "", l = $(".zonedword-wrap .zonedword-search-input").attr("data-dir"), c = $.trim($(".zonedword-wrap .zonedword-search-input").val()).replace(/<br( \/)?>/gi, "&lt;br$1&gt;"), $(".zonedword-result .dictionary-output").length > 0 ? (d = 1, e = $(".zonedword-result .dictionary-output"), e.each(function() {
                i += $(this).find(".dictionary-title").html(),
                i += $(this).find(".dictionary-comment").html()
            }), i = i.replace(/<(?!\/(div|p))[^<>]*>/gi, "").replace(/<\/(div|p)>/gi, "\r\n"), i = i.replace(/&gt;/gim, ">"), i = i.replace(/&lt;/gim, "<"), i = i.replace("详细释义>>", "")) : (d = 0, e = $(".zonedword-result .output-bd").find(".target-output"), e.each(function() {
                i += $(this).html().replace(/<br( \/)?>/gi, "&lt;br$1&gt;") + "<br />"
            }), i = i.replace(/<(?!br \/)[^<>]*>/gi, "").replace(/<br \/>/gi, "\r\n"))) : 1 === d ? (e = $(".dictionary-wrap .dictionary-output"), e.each(function() {
                i += $(this).find(".dictionary-title").html(),
                i += $(this).find(".dictionary-comment").html()
            }), i = i.replace(/<(?!\/(div|p))[^<>]*>/gi, "").replace(/<\/(div|p)>/gi, "\r\n"), i = i.replace(/&gt;/gim, ">"), i = i.replace(/&lt;/gim, "<"), i = i.replace("详细释义>>", "")) : (e = $(".output-wrap .output-bd").find(".target-output"), e.each(function() {
                i += $(this).html().replace(/<br( \/)?>/gi, "&lt;br$1&gt;") + "<br />"
            }), i = i.replace(/<(?!br \/)[^<>]*>/gi, "").replace(/<br \/>/gi, "\r\n")),
            i = i.replace(/&nbsp;/gim, " ");
            var s = a.get("maxCollectionCount");
            if (c.length > s || i.length > s) return void alert("囧, 原文和译文要是在" + s + "字以下就好啦 ^_^");
            var p = {
                req: "add",
                fanyi_src: c,
                fanyi_dst: i,
...
define("translation:widget/translate/setting/setting",
function(e) {
    "use strict";
    ...
    r = {
        ...
        initSetting: function() {
            ...
            o ? "0" === o ? ($(".realtrans-switch").removeClass("setting-checked"), t.set("isInRealtimeMode", !1)) : t.set("isInRealtimeMode", !0) : o || (s.setCookie("REALTIME_TRANS_SWITCH", 1, {
                expires: 864e8
            }), t.set("isInRealtimeMode", !0));
            var i = s.getCookie("FANYI_WORD_SWITCH");
            i ? "0" === i ? ($(".zonedword-switch").removeClass("setting-checked"), t.set("isInFanyiWordMode", !1)) : t.set("isInFanyiWordMode", !0) : i || (s.setCookie("FANYI_WORD_SWITCH", 1, {
                expires: 864e8
            }), t.set("isInFanyiWordMode", !0));
            var r = s.getCookie("HISTORY_SWITCH");
            r ? "0" === r ? ($(".history-switch").removeClass("setting-checked"), t.set("isInHistoryMode", !1)) : "1" === r && t.set("isInHistoryMode", !0) : (s.setCookie("HISTORY_SWITCH", 1, {
                expires: 864e8
            }), t.set("isInHistoryMode", !0));
            var d = s.getCookie("SOUND_SPD_SWITCH");
            d ? "0" === d ? ($("#spd-slow").addClass("sound-spd-radio-checked"), t.set("soundSpdMode", "slow")) : "2" === d ? ($("#spd-fast").addClass("sound-spd-radio-checked"), t.set("soundSpdMode", "fast")) : ($("#spd-normal").addClass("sound-spd-radio-checked"), t.set("soundSpdMode", "normal")) : (s.setCookie("SOUND_SPD_SWITCH", 1, {
                expires: 864e8
            }), $("#spd-normal").addClass("sound-spd-radio-checked"), t.set("soundSpdMode", "normal"));
            var a = s.getCookie("SOUND_PREFER_SWITCH");
            a ? "0" === a ? ($("#prefer-uk").addClass("sound-prefer-radio-checked"), t.set("soundPreferMode", "uk")) : ($("#prefer-en").addClass("sound-prefer-radio-checked"), t.set("soundPreferMode", "en")) : (s.setCookie("SOUND_PREFER_SWITCH", 1, {
                expires: 864e8
            }), $("#prefer-en").addClass("sound-prefer-radio-checked"), t.set("soundPreferMode", "en"));
            var c = n.supportLocalStorage ? localStorage.getItem("soundTrigger") : "";
            c || (c = "hover", n.supportLocalStorage && localStorage.setItem("soundTrigger", c)),
            $("#" + c + "-trigger").addClass("sound-trigger-radio-checked"),
            t.set("soundTriggerMode", c)
        },
        bindEvents: function() {
        ...
        settingBtnClick: function() {
            n.supportLocalStorage && "true" !== localStorage.getItem("PC3.5SettingBtnTagClicked") && (localStorage.setItem("PC3.5SettingBtnTagClicked", "true"), $(".setting-btn").removeClass("new-edition-tip")),
        ...
        collectionClick: function() {
            var e = t.get("account");
            if (_hmt.push(["_trackEvent", "首页", "web端点击收藏夹"]), "" === e.is_login) o.newLoginInstanceAsync();
            else {
        ...
        setRealtransSwitch: function() {
            ...
            var o;
            e.hasClass("setting-checked") ? (t.set("isInRealtimeMode", !0), o = 1, _hmt.push(["_trackEvent", "首页", "web端实时翻译打开"])) : (t.set("isInRealtimeMode", !1), o = 0, _hmt.push(["_trackEvent", "首页", "web端实时翻译关闭"])),
        ...
        setZonedwordSwitch: function() {
            ...
            e.toggleClass("setting-checked");
            var o;
            e.hasClass("setting-checked") ? (o = 1, t.set("isInFanyiWordMode", !0), _hmt.push(["_trackEvent", "首页", "web端划词翻译打开"])) : (o = 0, t.set("isInFanyiWordMode", !1), _hmt.push(["_trackEvent", "首页", "web端划词翻译关闭"])),
        ...
        setHistorySwitch: function() {
            ...
            e.toggleClass("setting-checked");
            var o;
            e.hasClass("setting-checked") ? (o = 1, t.set("isInHistoryMode", !0), _hmt.push(["_trackEvent", "首页", "设置-历史记录-开启"])) : (o = 0, t.set("isInHistoryMode", !1), _hmt.push(["_trackEvent", "首页", "设置-历史记录-关闭"])),
            i.onHistoryInput(),
...
define("translation:widget/translate/translang/translang",
function(t) {
    "use strict";
    var n = t("translation:widget/common/environment"),
    a = t("translation:widget/translate/translang/fromlang"),
    e = t("translation:widget/translate/translang/tolang"),
    l = t("translation:widget/translate/translang/exchange"),
    c = t("translation:widget/translate/translang/transbtn"),
    i = {
        init: function() {
            this.addOcrSupport(),
            this.bindEvents()
        },
        addOcrSupport: function() {
            var t = $(".language-data .data-lang, .language-data span.data-lang");
            t.each(function() {
                var t = $(this);
                n.get("ocrLangList").includes(t.attr("value")) && t.addClass("support-ocr")
            })
        },
        bindEvents: function() {
            $(".trans-operation-wrapper").on("click", ".select-from-language", $.proxy(this.clickFromBtn, this)).on("click", ".select-to-language", $.proxy(this.clickToBtn, this)).on("click", ".from-to-exchange", $.proxy(this.clickExchangeBtn, this)).on("click", ".from-language-list .language-data a", $.proxy(this.clickFromItem, this)).on("click", ".to-language-list .language-data a", $.proxy(this.clickToItem, this)).on("click", ".from-language-list .language-often li a", $.proxy(this.clickFromOfen, this)).on("click", ".to-language-list .language-often li a", $.proxy(this.clickToOfen, this)),
            $("#translate-button").on("click", $.proxy(this.clickTranslate, this)),
            $(".manual-trans-btn").on("click",
            function() {
                _hmt.push(["_trackEvent", "首页", "web端点击人工翻译按钮"])
            }),
            $(".manual-trans-btn .expert-logo").on("click",
            function() {
        ...
        clickFromItem: function(t) {
            n.set("langChangedByUser", !0),
            a.fromlangItemSelect({
                target: $(t.target),
                trans: !0
            }),
            _hmt.push(["_trackEvent", "首页", "web端点击源语言列表item"])
        },
        clickToItem: function(t) {
            e.tolangItemSelect({
                target: $(t.target),
                trans: !0
            }),
        ...
        clickBody: function(t) {
            var n = $(t.target);
            "block" === $(".from-language-list").css("display") && (n.hasClass("select-from-language") || n.parents(".select-from-language").length > 0 || n.hasClass("from-language-list") || n.parents(".from-language-list").length > 0) || a.hideFromWrap(),
            "block" === $(".to-language-list").css("display") && (n.hasClass("select-to-language") || n.parents(".select-to-language").length > 0 || n.hasClass("to-language-list") || n.parents(".to-language-list").length > 0) || e.hideToWrap()
        },
        clickFromOfen: function() {
            _hmt.push(["_trackEvent", "首页", "web端常用语种区域点击量（源语言）"])
        },
        clickToOfen: function() {
...
define("translation:widget/translate/zonedword/zonedword",
function(o) {
    "use strict";
    var t = o("translation:widget/translate/zonedword/wordWrap"),
    n = (o("translation:widget/translate/input/sound"), o("translation:widget/common/soundURIGenerator")),
    ...
    d = {
        ...
        bindEvents: function() {
            ...
            $("#zonedword-wrap").on("click", ".zonedword-close", this.onCloseZonedword).on("click", ".zonedword-setting-icon", this.toggleZoneWordOption).on("click", ".zonedword-switch", this.switchZoneword).on("click", ".zonedword-detail-link", this.onClickMore).on("click", ".op-sound",
            function() {
                o.onClickSound({
                    target: this
                })
            ...
            }).on("mouseleave", ".op-sound", $.proxy(this.onSoundMouseOut, this)).on("click",
            function(o) {
                var t = $(o.target);
        ...
        documentIsClick: function(o) {
            var n = $(o.target);
            n.parents("#zonedword-wrap").length > 0 || ($("#zonedword-wrap .setting-options").hide(), t.hideWrap())
        },
        ...
        switchZoneword: function(o) {
            ...
            var n;
            t.hasClass("setting-checked") ? (n = 1, r.set("isInFanyiWordMode", !0)) : (n = 0, r.set("isInFanyiWordMode", !1), _hmt.push(["_trackEvent", "首页", "Web点击划词翻译框关闭划词翻译功能"])),
...
define("translation:widget/footer/banner/banner",
function(n, t) {
    "use strict";
    function i() {
        var n = d.length;
    ...
    function c(n) {
        ...
        if (n > 1) {
            var i = function() {
                var i = d.eq(t);
                t >= n - 1 ? t = 0 : t++;
                for (var e = d.eq(t), a = 0; n > a; a++) d[a].style.visibility = a === t ? "visible": "hidden";
                i.css("opacity", 0),
                e.css("opacity", 1)
            },
            e = null;
    ...
    function r() {
        $(document).delegate(".spread-slide", "click",
        function(n) {
            var t = $(n.target).closest("a"),
            i = t.attr("data-index");
            s(i)
        }).on("click", ".spread-slide-close",
        function() {
            $(".spread-slide").hide()
        })
    }
...
define("translation:widget/footer/copyright/copyright",
function(t, n) {
    "use strict";
    function i() {
        $(".foot-manual-link").on("click",
        function() {
...
define("translation:widget/footer/extra/extra",
function(n, t) {
    "use strict";
    function o() {
        var n = $(".manual-spread");
        return n.length > 0 && !n.hasClass("manual-spread-none") ? void a.css("top", .7 * $(window).height()) : void a.css("top", .7 * $(window).height()).show()
    }
    function i() {
        $(window).on("resize", o),
        s.on("click", e)
...
define("translation:widget/footer/follow/follow",
function(o, t) {
    "use strict";
    function i() {
    ...
    function l(o) {
        var t = o.target;
        return t === this || t === $("#fdialog-close").get(0) ? ($("#follow-dialog").addClass("hide"), o.stopPropagation(), !1) : void 0
    }
    t.init = function() {
        i()
    }
});;
define("translation:widget/footer/footer",
function(i) {
    "use strict";
    function t() {
